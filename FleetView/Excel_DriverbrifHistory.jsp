...
%>
<%
String drivername=request.getParameter("driverNm");
    ...
    <!-- body part come here -->
 		...
 		<tr><td>
				<table width="100%" align="center" border="0">
         		...
         		<div id="report_heding" align="center"><b><font color="brown" size="2"><% if(pagefrom.equals("brif")) {out.print(" Briefing ");}else if(pagefrom.equals("debrif")){ out.print(" De-Briefing ");}else{out.print(" Briefing Debriefing  ");} %> report for <%=drivername %> from <%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(date1))%> to <%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(date2))%></font></div>
         		<div align="right">
...
<tr bgcolor="lightgrey">
	<th class="hed" rowspan="2" align="center"> Sr.</th>
		...
		{
		%>
			<th class="hed" rowspan="2" colspan="3" align="center"><b> Briefing Date</th>
		<%
		}
		else if((pagefrom.equals("debrif")))
		{
		%>
			<th class="hed" rowspan="2" colspan="3" align="center"><b> Debriefing Date</th>
		<%
		...
		{
%>
		<td colspan="3" rowspan="2"><b></>Briefing Date</td>
		<td colspan="3" rowspan="2"><b></>Debriefing Date</td>
<%
		}
		...
		{	
%>
<th colspan="3" rowspan="2"><b></>Trainer Name</td>
<%
		}
		else if(pagefrom.equals("debrif"))
		{	
%>
<td colspan="3" rowspan="2"><b></>Trainer Name</td>
<%
		}
		else
		{
%>
<td colspan="3" rowspan="2"><b></>Briefing Trainer</td>
<td colspan="3" rowspan="2"><b></>Debriefing Trainer</td>
<%
		}
%>
			...
			if(pagefrom.equals("brif"))
			{
				sql="select * from t_briefing where driverid like '"+driverid+"' and  brifdate>='"+date1+" 00:00:00' and brifdate<='"+date2+" 23:59:59' order by brifdate desc";
			}
			else if(pagefrom.equals("debrif"))
			{
				sql="select * from t_debriefing where driverid like '"+driverid+"'  and  Debriefdate>='"+date1+" 00:00:00' and Debriefdate<='"+date2+" 23:59:59' order by Debriefdate desc";
			}
			else
			{
				sql="select a.brifdate,a.tripid,a.drivername,a.driverid,b.debriefdate,a.gpsdata,a.jrm,a.remark as BriefingRemark,b.trainername as dbtrainer,a.trainername as btrainer,b.remark as DebriefingRemark from t_briefing a,t_debriefing b where (a.driverid like '"+driverid+"') and a.debrifstatus like 'debrifed' and (a.briefid=b.briefid) and (a.brifdate>='"+date1+" 00:00:00' and a.brifdate<='"+date2+" 23:59:59') order by a.brifdate desc";
			}	
			//out.print(sql);		
			...
			{	
			%>
			<td colspan="3"><%=rst.getString("trainername")%></td>
			<%
			}
			else if(pagefrom.equals("debrif"))
			{	
