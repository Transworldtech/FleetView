...
function feedbackReport(driverid)
{
	var incidentClicked=document.getElementById("incidentid").value;
	//alert(incidentClicked);
	window.open("feedbackReportDbrf.jsp?incidentid="+incidentClicked+"&driverid="+driverid,'myWind2','width=800,height=600,resizable=yes,scrollbars=yes');
}
</script>
 	...
 	<table border="0" width="70%" align="center" class="sortable_entry">
				<tr align="center">
					...
					<tr align="center" id="dispLinks2" style="display:none">
						<td align="center"><font  size="2"><a href="#" onclick="feedbackReport(<%=driverId%>);">Feedback Report</a></font></td>
					</tr>
