...
//String user="Castrol";
String getveh=request.getParameter("vehic");

session.setAttribute("vehic",getveh);
...
/***********end of Code for Night Driving ************/
 ...
 out.print("Last 24 Hours Exception Report of Vehicle "); 
        //out.print("<table border='0' width='100%'> ");
        //out.print("<tr> <td> <div align='right'> <a href='excelrepvehexcep.jsp' title='Export this report to Excel'> <img  src='images/excel.jpg' width='15px' height='15px'> </a> </td> </tr>");
       //out.print("</table>");
 ...
 out.print("</font> </div> </th> ");
   ...
   out.print("<td> <div align='right'> <a href='excelrepvehexcep.jsp' title='Export this report to Excel'> <img  src='images/excel.jpg' width='15px' height='15px'> </a> </td>");
