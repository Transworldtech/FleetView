...
String oilgrade=request.getParameter("oilgrade");
String oilcapacity=request.getParameter("oilcapacity");
String type=request.getParameter("type");
String ratio=request.getParameter("ratio");
String noofunits=request.getParameter("noofunits");
String shaftdetails=request.getParameter("shaftdetails");
String flangesize=request.getParameter("flangesize");
String VehRegNo=request.getParameter("VehRegNo");
System.out.println("VehId on Pto insertpage---->"+VehRegNo); 
%>
<%@ include file="headernew.jsp"%> 
<form name="userform" action="Editptoinsert.jsp" method="post" onsubmit="return formValidation();">
<br>
<br>
...
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b><font size="2" color="red">*</font>Serial Number</b> </label><input id="element_3_2" name="element_3_2"  class="element text medium" type="text"  value="<%=serialnumber%>"/><br><label id="element_error_2"></label><br><br><!--1,2--></td>
</tr>
<tr>
...
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Type</b> </label><input id="element_3_5" name="element_3_5"  class="element text medium" type="text"  value="<%=type%>"/><br><label id="element_error_5"></label><br><br><br><!--3,1--></td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Ratio </b> </label><input id="element_3_6" name="element_3_6"  class="element text medium" type="text"  value="<%=ratio%>"/><br><label id="element_error_6"></label><br><br><br><!--3,2--></td>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>No Of Units</b> </label><input id="element_3_7" name="element_3_7"  class="element text medium" type="text"  value="<%=noofunits%>"/><br><label id="element_error_7"></label><br><br><br><!--4,1--></td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Shaft Details </b> </label><input id="element_3_8" name="element_3_8"  class="element text medium" type="text"  value="<%=shaftdetails%>"/><br><label id="element_error_8"></label><br><br><br><!--4,2--></td>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Flange Size</b> </label><input id="element_3_9" name="element_3_9"  class="element text medium" type="text"  value="<%=flangesize%>"/><br><label id="element_error_9"></label><br><br><br><!--5,1--></td>
<td><!--5,2--></td>
</tr>
