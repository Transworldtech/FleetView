...
function showexpence(field){
      ...
      //var test=document.getElementById("element_3_2").value;
      //alert("element_3_2.value:-"+element_3_2.value);
      //element_3_2.value.replace("&","$$");
     // alert("fieldbefor:-"+field);
...
//alert("ajax 222");
	...
	//alert(queryString);
	ajaxRequest.open("POST", "Djettingpumpajax.jsp" + queryString, true);
...
//			  	alert("in delete function");
			 	if(agree)
			     {
			            ...
			            // alert("before delete");
			            window.location="Djettingpumpdelete.jsp?&rid="+id;
...
<br>
<br>
<div align="center" class="headerlay"><table style="color:#fff;"><tbody><tr><td><label id="element_1" name="element_1"  class="description" for="element_1"><font size="3" color="black"><b>Add Custom Field For Jetting Pump</b></font> </label></td></tr></tbody></table></div>
...
<a href="EditDJetting.jsp?VehId=<%=VehId%>&VehRegNo=<%=VehRegNo%>"><font color="Blue" size="2">Go Back</font></a>
</div>
...
<tr>
						...
						<% int j=1;
    String Sqlday="select * from db_gps.t_jettingpumpforcustomfieldmaster where Owner='"+transporter+"' order by id";
	...
	{ %>
		...
		<td align='right'  width="25px"><div align='right'><%=j%></div></td>
                <td align='right'><div align='left'><%=rst2.getString("field")%></div></td>
