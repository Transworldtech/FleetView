...
sql="update db_gps.t_briefing set ApproveM='Medicale Checkup Date Expired',MReason='"+mr+"',ApproveBy='"+Trainer+"' where Driverid='"+DriveId+"' and  BriefId='"+BrifId+"'";
...
*/
		...
		html1 = "<html><body>Dear Sir/Mam,<br><br> Warm Greetings!!! <br><br>DMC Person : "+Trainer+" Approved the Driver for Trip, which is not inline with Policy.<br> Details are as below : <br><br>"
				+"Approve Caution:- Refresher Training Required<br>Approve Reason:-"+mr+"<br>Approve By:- "+Trainer+"<br>"		
				...
				subject = "Approval For Medical Checkup Date Expired ";
