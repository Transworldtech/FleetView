...
//alert("ajax 222");
	...
	//alert(queryString);
	ajaxRequest.open("POST", "Dcontrolajax.jsp" + queryString, true);
		 ...
		 try{
			 ...
			 var agree=confirm("Do You Want to Delete this Entry??");
			 	...
			 	if(agree)
			     {
			            ...
			            window.location="Dcontroldelete.jsp?&rid="+id;
...
<br>
<br>
<div align="center" class="headerlay"><table style="color:#fff;"><tbody><tr><td><label id="element_1" name="element_1"  class="description" for="element_1"><font size="3" color="black"><b>Add Custom Field For Control System</b></font> </label></td></tr></tbody></table></div>
...
<a href="EditDcontrol.jsp?VehId=<%=VehId%>&VehRegNo=<%=VehRegNo%>"><font color="Blue" size="2">Go Back</font></a>
</div>
...
<tr>
						...
						<% int j=1;
    String Sqlday="select * from db_gps.t_controlsystemforcustomfieldmaster where Owner='"+transporter+"' order by id";
