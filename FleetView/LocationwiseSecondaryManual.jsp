...
<tr><td align="left"><!-- <div align="left"><font size="3" >Report No: 10.26.1</font></div>--></td></tr>
<tr><td>
<%

%>
<font size="2"><b>Secondary Manual Trips Report for <%=startplace%> from <%=data%> to <%=data1%></b></font>
<div align="right">
				<a href="#" onclick="javascript:window.open('print_locationsecondarymanual.jsp?startplace=<%=startplace.replace("&","and")%>&date1=<%=data %>&date2=<%=data1 %>&triptype=<%=triptype%>');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; 
				<a href="excel_locationsecondarymanual.jsp?startplace=<%=startplace.replace("&","and")%>&date1=<%=data %>&date2=<%=data1 %>&triptype=<%=triptype%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>
...
<table border="1" width="100%" class="sortable">
			...
			if(triptype.equalsIgnoreCase("Started"))
			{
				...
				String sql11="Select count(CD) as cdcount1 from t_CastrolTripsStarted where CD='Yes' and TripStartDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
				...
				String sql12="Select count(ND) as ndcount1 from t_CastrolTripsStarted where ND='Yes' and TripStartDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
				...
				String sql13="Select count(Briefing) as bcount1 from t_CastrolTripsStarted where Briefing='briefed' and TripStartDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
				...
				String sql14="Select count(Debriefing) as dbcount1 from t_CastrolTripsStarted where Debriefing='Yes' and TripStartDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
				...
				String sqlall="Select * from t_CastrolTripsStarted where TripStartDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
...
<!--							</td></tr>-->
			...
			{
				String sqll="select count(TripID) as TripID,count(Distinct(DriverID)) as DriverID,count(Distinct(Vehid)) as Vehid,sum(KmTraveled) as KmTraveled,sum(OSCount) as OSCount,sum(OSDusration) as OSDuration,sum(RACount) as RACount,sum(RDCount) as RDCount  from t_CastrolTripsEnded where TripEndDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
			//	System.out.println(sqll);
				ResultSet rstt=stt.executeQuery(sqll);
				while(rstt.next())
				{
				...
				String sql11="Select count(CD) as cdcount1 from t_CastrolTripsEnded where CD='Yes' and TripEndDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
				ResultSet rstcd=st.executeQuery(sql11);
				if(rstcd.next())
				{
					//cdcount=rstcd.getInt("cdcount1");
				...
				String sql12="Select count(ND) as ndcount1 from t_CastrolTripsEnded where ND='Yes' and TripEndDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
				ResultSet rstnd=st.executeQuery(sql12);
				if(rstnd.next())
				{
					//ndcount=rstnd.getInt("ndcount1");
				...
				String sql13="Select count(Briefing) as bcount1 from t_CastrolTripsEnded where Briefing='briefed' and TripEndDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
				ResultSet rstb=st.executeQuery(sql13);
				if(rstb.next())
				{
					//bcount=rstb.getInt("bcount1");
				...
				String sql14="Select count(Debriefing) as dbcount1 from t_CastrolTripsEnded where Debriefing='Yes' and TripEndDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
				ResultSet rstdb=st.executeQuery(sql14);
				if(rstdb.next())
				{
					//dbcount=rstdb.getInt("dbcount1");
				...
				String sqlall="Select * from t_CastrolTripsEnded where TripEndDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
				ResultSet rstall=st1.executeQuery(sqlall);
				while(rstall.next())
				{
...
<!--			</td></tr>-->
	...
	<%
			...
			{
				String sqll="select count(TripID) as TripID,count(Distinct(DriverID)) as DriverID,count(Distinct(Vehid)) as Vehid,sum(KmTraveled) as KmTraveled,sum(OSCount) as OSCount,sum(OSDusration) as OSDuration,sum(RACount) as RACount,sum(RDCount) as RDCount  from t_CastrolTripsStartEnded where TripStartDate>='"+data+" 00:00:00' and TripEndDate<='"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
			//	System.out.println(sqll);
				ResultSet rstt=stt.executeQuery(sqll);
				while(rstt.next())
				{
				...
				String sql11="Select count(CD) as cdcount1 from t_CastrolTripsStartEnded where CD='Yes' and TripStartDate>='"+data+" 00:00:00' and TripEndDate<='"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
				ResultSet rstcd=st.executeQuery(sql11);
				if(rstcd.next())
				{
					//cdcount=rstcd.getInt("cdcount1");
				...
				String sql12="Select count(ND) as ndcount1 from t_CastrolTripsStartEnded where ND='Yes' and TripStartDate>='"+data+" 00:00:00' and TripEndDate<='"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
				ResultSet rstnd=st.executeQuery(sql12);
				if(rstnd.next())
				{
					//ndcount=rstnd.getInt("ndcount1");
				...
				String sql13="Select count(Briefing) as bcount1 from t_CastrolTripsStartEnded where Briefing='briefed' and TripStartDate>='"+data+" 00:00:00' and TripEndDate<='"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
				ResultSet rstb=st.executeQuery(sql13);
				if(rstb.next())
				{
					//bcount=rstb.getInt("bcount1");
				...
				String sql14="Select count(Debriefing) as dbcount1 from t_CastrolTripsStartEnded where Debriefing='Yes' and TripStartDate>='"+data+" 00:00:00' and TripEndDate<='"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
				ResultSet rstdb=st.executeQuery(sql14);
				if(rstdb.next())
				{
					//dbcount=rstdb.getInt("dbcount1");
				...
				String sqlall="Select * from t_CastrolTripsStartEnded where TripStartDate>='"+data+" 00:00:00' and TripEndDate<='"+data1+" 23:59:59' and Category='Secondary' and status<>'Faulty' and StartPlace='"+startplace+"' and EndedBy<>'-' and tripenddate<>'NA'";
				ResultSet rstall=st1.executeQuery(sqlall);
				while(rstall.next())
				{
