...
String filename=session.getAttribute("user").toString()+showdatex+"weeklyhrsViolation.xls";
...
try
{
	...
	drivernm=request.getParameter("drivernm");
	//String Transporter=session.getAttribute("usertypevalue").toString();
			...
			if(thename.equals("started"))
			{
				...
				<tr align="center"><td colspan="12"><b>
				...
				<tr><td colspan="12"><div class="bodyText" align="left"> 
