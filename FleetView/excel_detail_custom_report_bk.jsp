...
String sqlnew="select * from db_gpsbackup2012.t_veh"+VehicleCode+" where concat(TheFieldDataDate,' ',TheFieldDataTime) <='"+datenew1+" "+fromtime+"' order by concat(TheFieldDataDate,' ',TheFieldDataTime) desc limit 1";
...
sql="select * from db_gpsbackup2012.t_veh"+VehicleCode+" where concat(TheFieldDataDate,' ',TheFieldDataTime) >='"+datenew1+" "+fromtime+"' and concat(TheFieldDataDate,' ',TheFieldDataTime) <='"+datenew2+" "+totime+"' and TheFiledTextFileName in ('SI','OF','ON') order by concat(TheFieldDataDate,' ',TheFieldDataTime) asc";
...
%>
	<tr>
		...
		<td class="bodyText" align="left"><div align="left"><%=new SimpleDateFormat(dateformat).format(rst1.getDate("TheFieldDataDate"))%> <%=rst1.getString("TheFieldDataTime")%></div></td>
...
while(rst1.next())
{
				...
				if(rst1.getString("TheFiledTextFileName").equals("ON")||rst1.getString("TheFiledTextFileName").equals("SI"))
				{
					if(rst1.getString("TheFiledTextFileName").equals("SI"))
					{
						...
						if(mils3 > 20)
						{
							...
							<tr>
						<td class="bodyText" align="right"><div align="right"><%=i%></div></td>
						<td class="bodyText" align="left"><div align="left"><%=new SimpleDateFormat(dateformat+" HH:mm:ss").format(dt1)%></div></td>
						<%
					/*	if(mils3>=60)
						{
							hrs=mils3/60;
	...
	%>
					...
					<tr>
												<td class="bodyText" align="right"><div align="right"><%=i%></div></td>
												<td class="bodyText" align="left"><div align="left"><%=new SimpleDateFormat(dateformat+" HH:mm:ss").format(dt2)%></div></td>
