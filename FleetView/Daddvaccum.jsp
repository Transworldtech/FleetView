...
<form name="userform" action="Daddvaccuminsert.jsp" method="post" onsubmit="return formValidation();">
<br>
<br>
<div align="center" class="headerlay"><table style="color:#fff;"><tbody><tr><td><label id="element_1" name="element_1"  class="description" for="element_1"><font size="3" color="black"><b>Vacuum Pump User Field</b></font> </label></td></tr></tbody>
<div align="center">
...
String abc="select field from db_gps.t_vaccumsystemforcustomfieldmaster where Owner='"+transporter+"'";
