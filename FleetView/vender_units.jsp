...
try{
	...
	sql="select * from t_unitmaster a, allconnectedunits b where a.User='"+session.getAttribute("usertypevalue").toString()+"' and a.UnitID=b.UnitID and b.VehNo='-' order by concat(b.TheDate,b.TheTime) desc";
...
<td class="bodyText"><div align="right"><a href="unidentified_history.jsp?unitid=<%=rst.getString("UnitID")%>&data=<%=rst.getString("TheDate")%>" title="Click to see 24 Hour History"><%=rst.getString("UnitID")%></a></div></td>
<td class="bodyText"><%
