...
{  
          ...
          document.Total_cd.action ="excel.jsp";
          document.forms["Total_cd"].submit();
...
<%int counter=0;
	...
	final String data2 = (null != request.getParameter("dd")) ? 
			...
			String  exportFileName=session.getAttribute("user").toString()+"_Total_CD.xls";

			%>

<form id="Total_cd" name="Total_cd" action="excel.jsp" method="post"
	autocomplete="off">
...
%>
				...
				<font size="3"><b>Continuous Driving Report</b></font> <%
					}
...
// string tokens...
	...
	String query="select * FROM db_gpsExceptions.t_veh"+aa+"_cr where FromDate >='"+data1+"' AND ToDate <= '"+data2+"' ";
