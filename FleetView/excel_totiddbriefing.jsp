...
<% 
	...
	String filename=session.getAttribute("user").toString()+showdatex+"CastrolDeBriefing_Report.xls";
...
<% nf.setMaximumFractionDigits(2);
  ...
  // System.out.println(todate);
   ...
   //data1=new SimpleDateFormat("MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(request.getParameter("fromdate")));
...
while(rstt.next())
{
	...
	vehcountall=rstt.getInt("Vehid");
			...
			String sqlall="Select * from t_CastrolTripsStarted where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Debriefing='Yes' and status<>'Faulty'";
