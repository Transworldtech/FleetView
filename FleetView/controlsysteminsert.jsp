...
String value0=request.getParameter("element_3_2"); 
String value1=request.getParameter("element_3_3");
...
String sqlinsert="insert into db_gps.t_controlsystem(Vehcode,Entryby,Owner,pto,acceleration,control_panel_location,jetting_pressure_gauge,suction_pressure_gauge,hyd_pressure_gauge) values('"+vehid+"','"+user+"','"+transporter+"','"+pto+"','"+value0+"','"+value1+"','"+value2+"','"+value3+"','"+value4+"')";  

System.out.println("first time in sert for control"+sqlinsert);
 count=stmt.executeUpdate(sqlinsert);
 
 
 
 String sqlinsert1="insert into db_gps.t_controlsystemhistory(Vehcode,Entryby,Owner,pto,acceleration,control_panel_location,jetting_pressure_gauge,suction_pressure_gauge,hyd_pressure_gauge) values('"+vehid+"','"+user+"','"+transporter+"','"+pto+"','"+value0+"','"+value1+"','"+value2+"','"+value3+"','"+value4+"')";  

 System.out.println("first time in sert for control history"+sqlinsert1);
...
out.println("</script>");
	  ...
	  out.println("<script type='text/javascript'>alert('Control Record Inserted Successfully');");
		//out.println("location='showperipheralsDet.jsp'");
		// response.sendRedirect("showperipheralsDet.jsp?VehId="+vehid+"&VehRegNo="+VehRegNo);
		out.println("location='showperipheralsDet.jsp?VehId="+vehid+"&VehRegNo="+VehRegNo+"'");
		out.println("</script>");
