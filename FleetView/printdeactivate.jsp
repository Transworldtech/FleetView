...
%>
			...
			String sql="select * from t_vehicledetails where vehiclecode in "+VehList1+" and Status='DeActivated'";  
				...
				<td style="background-color:#EEC5C8;"><%=rstremoved1.getString("VehicleRegNumber")%></td>	
				<td style="background-color:#EEC5C8;">
				<%
					try{
				...
				<td style="background-color:#EEC5C8;"><%=rstremoved1.getString("InstalledPlace")%></td>	
