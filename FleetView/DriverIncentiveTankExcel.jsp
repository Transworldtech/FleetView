...
if(cnt>1)
{
	filename = filename.substring(0,cnt)+"_DriverIncentiveForTankerReport.xls";
	filename=filename.replace(" ","_");
}
else
{
	filename =session.getAttribute("user").toString()+"_DriverIncentiveForTankerReport.xls";
	filename=filename.replace(" ","_");
}
...
<tr>
<td align="center" colspan="10" ><font size="3"><b>Driver Incentive Report For Tanker Trips From  <%=new SimpleDateFormat("MMM-yyyy").format(new SimpleDateFormat("MM-yyyy").parse(Mon+"-"+Yer))  %>  To <%=new SimpleDateFormat("MMM-yyyy").format(new SimpleDateFormat("MM-yyyy").parse(Mon1+"-"+Yer1))  %></b></font></td>
</tr>
<tr>
