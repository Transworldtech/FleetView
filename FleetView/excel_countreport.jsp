...
<%
		...
		String sql = "SELECT * FROM `t_ndaproved` WHERE `Transporter` LIKE '"+transporter+"' AND `StoredDate` BETWEEN '"+date1+"'AND '"+date2+"'";
...
%>
			<tr>
				...
				<td style=" text-align: left"><%= rst.getString("Duration") %></td>
				<td style=" text-align: left"><%= rst.getString("SenderName") %></td>
				<td style=" text-align: left"><%= rst.getString("MobNo") %></td>
				<td style=" text-align: left"><%= rst.getString("StoredDate") %></td>
				<td style=" text-align: left"><%= rst.getString("StoredTime") %></td>
				<td style=" text-align: left"><%= rst.getString("Reason") %></td>
				<td style=" text-align: left"><%= rst.getString("Intimation") %></td>
			</tr>
<% 
