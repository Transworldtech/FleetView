...
{
	filename = filename=session.getAttribute("user").toString()+"_detail_report.xls";
}
        ...
        <tr>
          ...
          <td>
			...
			<div id="report_heding"><font color="brown" size="3">Detail Report For Vehicle <%=vehicle%> On Date :<%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(dd))%></font></div>
				<div align="right">
				<!--<a href="print_daydetails.jsp" onclick="javascript:window.print();" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; 
