...
// System.out.println("VVehRegNoVehRegNoVehRegNoVehRegNoeVehRegNohReVehRegNogNo"+VehRegNo);
...
try{
String sqlinsert="Update db_gps.t_hydrolicsystem  set Owner='"+transporter+"',Entryby='"+user+"',Type='"+value0+"',Capacity='"+value1+"',Pressure='"+value2+"',Drive='"+value3+"',Tank_Capacity='"+value4+"',Oil_Grade='"+value5+"',Make_Vendor='"+value6+"',Hyd_Cylinders_Numbers='"+value7+"',Door_Cylinder_size='"+value8+"',Door_Cylinder_Nos='"+value9+"',Door_Clamp_Size='"+value10+"',Door_Clamp_Nos='"+value11+"',Boom_Fwd_Rev_Size='"+value12+"',Boom_Fwd_Rev_Nos='"+value13+"',Boom_Up_Down_Size='"+value14+"',Boom_Up_Down_Nos='"+value15+"',Directional_Control_Valve_Make='"+value16+"',Pressure_Relief_Valve_Make='"+value17+"',Speed_Control_Valve_Make='"+value18+"',Pilot_Valve_Make='"+value19+"',Tipping_Cyclinder_Make='"+value20+"',Filters_Specification='"+value21+"' where VehCode='"+VehId+"' "; 
...
{
	 //cnt=0;
out.println("<script type='text/javascript'>alert('Hydraulic Record Updated Successfully');");
...
out.println("</script>");
	  ...
	  out.println("<script type='text/javascript'>alert('Hydraulic Record Updated For This Vehicle');");
		//out.println("location='showperipheralsDet.jsp'");
	//	 response.sendRedirect("showperipheralsDet.jsp?VehId="+vehid+"&VehRegNo="+VehRegNo);
	//response.sendRedirect("showperipheralsDet.jsp?VehId="+vehid+"&VehRegNo="+VehRegNo);
