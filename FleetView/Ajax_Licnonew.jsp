...
String sqllicno="select * from db_gps.t_drivers where licenseno ='"+licno12+"' and ACTIVESTATUS='Active'";
...
if(rsck.next())
{
	...
	own=rsck.getString("Owner");
     ...
     out.println("License is Already registered and active with "+own+ " and  driver " +dir );
