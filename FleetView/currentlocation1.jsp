...
{
%>
<td class="hed" align="center"><%=rsx.getString("Sen1")%></td>
<td class="hed" align="center"><%=rsx.getString("Sen2")%></td>
<td class="hed" align="center"><%=rsx.getString("Sen3")%></td>
<td class="hed" align="center"><%=rsx.getString("Sen4")%></td>
<%
}
else
{
...
{
%>
<td class="hed" align="center"><%=rsx1.getString("Sen1")%></td>
<td class="hed" align="center"><%=rsx1.getString("Sen2")%></td>
<td class="hed" align="center"><%=rsx1.getString("Sen3")%></td>
<td class="hed" align="center"><%=rsx1.getString("Sen4")%></td>
<%
}
else
{
