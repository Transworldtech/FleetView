...
<a href="#" onclick="javascript:window.open('printrapiddeacc.jsp?dd=<%=request.getParameter("dd")%>');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; <a href="excelrapiddeacc.jsp?dd=<%=request.getParameter("dd")%>" title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>&nbsp;&nbsp;&nbsp;
<%=fleetview.PrintDate() %>
</div>
	 </td></tr>
</table>
