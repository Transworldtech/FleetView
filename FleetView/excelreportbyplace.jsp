...
String filename=session.getAttribute("user").toString()+showdatex+"vehicle_near_to_depots.xls";
...
<div align="right"><%=fleetview.PrintDate()%></div>
</td></tr>
<tr><td>
...
<tr>
<td>Sr.</td>
<td class="hed">Vehicle R.No.</td><td class="hed">Transporter</td><td class="hed">Date</td><td class="hed">Time</td><td class="hed">Distance In Km.</td><td class="hed">Location</td></tr>
...
<tr>
<td><%=i%></td>
<td class="bodyText" align="left"><%=rst1.getString("VehicleRegNo")%></td>
<td class="bodyText" align="left"><%=rst1.getString("Transporter")%></td>
<td class="bodyText" align="left"><%=showdate1%> <%=rst1.getString("TheTime")%>
</td>

<td class="bodyText" align="left"><%=rst1.getString("TheTime")%></td>

<td class="bodyText" align="right"><%=dist1%></td>

<td class="bodyText" align="left"><%=rst1.getString("Location")%></td></tr>
