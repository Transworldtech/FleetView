...
var id=document.getElementById("licenceno").value;
//alert("id:-"+id);
var ajaxRequest;  // The variable that makes Ajax possible!
...
function upload(num)
{
	...
	if(num==3)
	{
	  ...
	  document.getElementById("remove3").style.display="";
		  ...
		  alert("Please upload only jpg,png,jpeg,bmp format file");
...
<form name="drivermgt" action="insertnewdriver.jsp" method="post"  enctype="multipart/form-data" onsubmit="return validation('off')" >
<br>
<br>
<div align="center" class="headerlay"><table style="color:#fff;"><tbody><tr><td><label id="element_1" name="element_1"  class="description" for="element_1"><font size="3px" color="black"><b>Add Driver</b></font> </label></td></tr></tbody></table></div>
<table border="0" width="400" align="center" class="sortable_entry_new">
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><font color="red" size="2">*</font><b>Driver Id :</b> </label><input id="driverid" name="driverid"  style="width: 200px;"  class="element text medium" type="text"  value="" onblur="driveridfunc()"  /></textarea><br><br><!--1,1-->
                  <div>
				...
				<label id="dirid3" style="display: none;"><font face="Arial" size="1" color="red">Please Enter Valid Characters only </font></label> 			
				</div>
...
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><font color="red" size="2">*</font><b>Driver Name:</b> </label><input id="drivername" name="drivername"  class="element text medium" type="text"  value=""  onblur="func()"/></textarea><br><br><!--2,1-->
 <div>
...
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Father's Name:</b> </label><input id="fathername" name="fathername"  class="element text medium" type="text"  value="" onblur="fathernamefunction()"/></textarea><br><br><!--2,1-->
<div> 
...
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><font color="red" size="2">*</font> <b>Permanent Address:</b> </label><textarea id="address1" name="address1"  class="element textarea medium"   onblur="permanentaddressvalidation()"></textarea><br><br><!--3,1-->
<div> 
...
<td><label id="element_1" name="element_1"  class="description" for="element_1"><font color="red" size="2">*</font><b>Current Address:</b> </label><textarea id="address2" name="address2"  class="element textarea medium"  onblur="curraddrvalid()" ></textarea><br><br><!--3,2-->
<div> 
...
<option value="Male">Male</option><option value="Female">Female</option></select></textarea><br><!--4,1-->
<div>
...
<option value="Married">Married</option><option value="Unmarried">Unmarried</option></select></textarea><br><!--3,2-->
              <div>
				<label id="maritalstatus" style="display: none;"><font face="Arial" size="1" color="red">Please Select Marital status</font></label> 
				
				</div>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><font color="red" size="1">*</font> <b>DOB:</b> </label><input id="dob" name="dob"  class="element text medium" type="text" value="<%=datenew1%>" size="15" onblur="mydateofbirt()" readonly/>  </textarea><br><br><!--5,1--> <script type="text/javascript">Calendar.setup({inputField  : "dob", ifFormat    : "%d-%b-%Y", button      : "dob"});</script>
...
<td><label id="element_1" name="element_1"  class="description" for="element_1"><font color="red" size="2">*</font> <b>Mobile No:</b> </label><input id="mobno" name="mobno"  class="element text medium" type="text"  value="" onblur="mobfunc()"/></textarea><br><br><!--4,2-->
<div>
...
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Date Of Induction:</b> </label><input id="induction" name="induction"  class="element text medium" type="text" value="<%=datenew1%>" size="15" readonly/>
...
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Transporter:</b> </label>
  ...
  
 	{
		...
		String sqltransck="SELECT VehRegno FROM db_gps.t_group WHERE GPName='"+usertypevalue+"' group by VehRegno";
         System.out.println("**9"+usertypevalue);
...
<%-- <input id="transporter" name="transporter"  class="element text medium" type="text"  value="<%=username%>" readonly/></textarea><br><br><!--6,2--></td> --%>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><font color="red" size="2">*</font>  <b>License No:</b> </label><input id="licenceno" name="licensceno"  class="element text medium" type="text" value="" onblur="licnofunc();" ><br><br>
    <div>
...
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>License Expiry:</b> </label><input id="licenseexpiry" name="licenseexpiry"  class="element text medium" type="text" value="<%=datenew1%>" size="15" readonly/>
<script type="text/javascript">
  Calendar.setup({
...
<td >
      ...
      <label id="element_1" name="element_1"  class="description" for="element_1"><b>DOB Proof :</b> </label><input type="file" cols="40" name="Filename1" id="Filename1" value="" onchange="upload(1);" style="width: 250px"/>
...
<a href="#" onclick="rr();" id="remove1" style="display: none;"><font size="2" face="Arial">Remove</font></a>	  
		<input id="f6" name=f6 class="element text medium" type="text" maxlength="255" value="" style="width: 150px; height: 20px;display: none;"/><br> <br><!--7,1-->
...
<tr>
<td ><label id="element_1" name="element_1"  class="description" for="element_1"><b> Permanent Address Proof :</b> </label><input type="file" cols="40" name="Filename2" id="Filename2" value="" onchange="upload(2);" style="width: 250px"/>
...
<a href="#" onclick="removess();" id="remove2" style="display: none;"><font size="2" face="Arial">Remove</font></a>	  
		<input id="f7" name=f7 class="element text medium" type="text" maxlength="255" value="" style="width: 150px; height: 20px;display: none;"/> <br><br><!--7,1-->
...
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Driver License:</b> </label><input type="file" cols="40" name="Filename3" id="Filename3" value="" onchange="upload(3);" style="width: 250px"/>
...
<a href="#" onclick="removess1();" id="remove3" style="display: none;"><font size="2" face="Arial">Remove</font></a>	  
		<input id="f8" name=f8 class="element text medium" type="text" maxlength="255" value="" style="width: 150px; height: 20px;display: none;"/><br><br><!--7,1-->
...
<td><!--7,2--></td>
 ...
 <%
        ...
        if(ck != null)
        {
        	%> <script>  alert("This Driver ID already exists !");
        ...
        if(Save1!=null)
        {
        	...
        	//window.location="driverentrynew.jsp";
