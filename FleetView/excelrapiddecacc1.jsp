...
String filename=session.getAttribute("user").toString()+showdatex+"rapid_deccelaration.xls";
...
<tr bgcolor=""><td align="center"colspan="6"><font size="3"><b>RAPID DECELERATION for Trip <%=tripid%>
