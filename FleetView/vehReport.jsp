...
%>
			...
			<div align="right">
			<a href="#" onclick="javascript:window.open('printvehReport.jsp?data1=<%=data1%>&data2=<%=data2%>&transporter=<%=transporter%>&drivercode=<%=drivercode%>&name=<%=DriverName%>');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; <a href="excel_vehReport.jsp?data1=<%=data1%>&data2=<%=data2%>&transporter=<%=transporter%>&drivercode=<%=drivercode%>&name=<%=DriverName%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>&nbsp;&nbsp;&nbsp;Date : <%
