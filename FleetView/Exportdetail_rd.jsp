...
String filename=session.getAttribute("user").toString()+"deatail_rd_report.xls";
...
<tr><td align="center"><font size="3">
 <b>RAPID DE-ACCELERATION REPORT for Vehicle <%=vehregno %> From Date :<%
...
try{	
	...
	<td><div align="left"><%=fleetview.ShowLocationOnlyByDateTime(vehcode,rst.getString("TheDate"),rst.getString("TheTime")) %></div></td>
	</tr>
<%
	i++;
}
