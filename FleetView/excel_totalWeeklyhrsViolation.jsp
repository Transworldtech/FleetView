...
String filename=session.getAttribute("user").toString()+showdatex+"TotalWeeklyViolation.xls";
...
try
{
	...
	String list=request.getParameter("driverlist");
	...
	//String Transporter=session.getAttribute("usertypevalue").toString();
			...
			if(thename.equals("started"))
			{
				...
				<font size="2" colspan="2"><b>Report No : 6.2.2</b></font></div></td></tr>
				<tr align="center"><td  colspan="12"><b><font size="3">Weekly Driving Hrs Violation Report From <%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(fromdate)) %> To <%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(todate)) %></font></b></td></tr>
				<tr><td colspan="10"><div class="bodyText" align="left"> 
