	...
	<!--  Mian Code Comes Here -->
			...
			else
			{
				...
				//	System.out.println("hello...");	
					%>
			<th id="tdp0"> <b>Previous Day Avg.</b></th>
			<th id="tdm0"> <b>Avg. This Month</b></th>
			<th id="tdf0"> <b>Fuel</b></th>
			<th id="tdl0"> <b>Fuel Alert</b></th>
			<th id="tdy0"> <b>Yesterday's Fuel Added</b></th>
			<th id="tdr0"> <b>Day Shift Driver</b></th>
			<th id="tdn0"> <b>Night Shift Driver</b></th>
			<%
			...
			while(rst.next())
			{
				...
				else
				{
					...
					%>
					<td style="<%=bgcolor %>" id="tdp<%=i%>"><%= rst.getString("LastDayAVG")%></td>
					<td style="<%=bgcolor %>" id="tdm<%=i%>"><%= rst.getString("LastMonthAVG") %></td>
					<td style="<%=bgcolor %>" id="tdf<%=i%>">
					<%
					...
					%>
					<td style="<%=bgcolor %>" id="tdl<%=i%>"><%=ftcount%></td>
					<td style="<%=bgcolor %>" id="tdy<%=i%>"><%=facnt%></td>
					...
					<%	
						...
						{
					%>
						<td style="<%=bgcolor %>" id="tdr<%=i%>" align="center"><%=rs20.getString("DayshiftDriver")%>  (<%=rs20.getString("Mob1")%>)</td>
						<td style="<%=bgcolor %>" id="tdn<%=i%>" align="center"><%=rs20.getString("NightshiftDriver")%>  (<%=rs20.getString("Mob2")%>)</td>				
					<%		
						}
						else
						{	
					%>	
					<td style="<%=bgcolor %>" id="tdr<%=i%>">-</td>
					<td style="<%=bgcolor %>" id="tdn<%=i%>">-</td>			
					<%
						}
			...
			{
			%>
				<td style="<%=bgcolor %>" id="tdp<%=i%>">NA</td>
				<td style="<%=bgcolor %>" id="tdm<%=i%>">NA</td>
				<td style="<%=bgcolor %>" id="tdf<%=i%>">NA</td>
				<td style="<%=bgcolor %>" id="tdl<%=i%>">NA</td>
				<td style="<%=bgcolor %>" id="tdy<%=i%>">NA</td>
				<td style=" <%=bgcolor %>" id="tdr<%=i%>">NA</td>
				<td style="<%=bgcolor %>" id="tdn<%=i%>">NA</td>
			<%
			}
					}//else end tdx=hidefuel
				}	//else end tdx=show
...
<%
	...
	{
%>
		<td class="hed" align="center"  id="tdr<%=i%>"><%=rs20.getString("DayshiftDriver")%> (<%=rs20.getString("Mob1")%>)</td>
		<td class="hed" align="center"  id="tdn<%=i%>"><%=rs20.getString("NightshiftDriver")%> (<%=rs20.getString("Mob2")%>)</td>			
<%		
	}
	else
	{	
%>	
		<td class="hed" align="center"  id="tdr<%=i%>">-</td>
		<td class="hed" align="center"  id="tdn<%=i%>">-</td>			
<%
	}
