...
<script type="text/javascript">
	...
	{  
	    ...
	    document.veh15dreport.action ="excel.jsp";
	    document.forms["veh15dreport"].submit();
	} 
</script>
<form id="veh15dreport" name="veh15dreport" action="" method="post">
<%
...
%>
<%	   String exportFileName=session.getAttribute("user").toString()+"_15DaysReport.xls";
 %>
...
<table width="100%" align="center" class="stats" >
			...
			<font  size="3" ><b>Last 15 Days Report</b></font></td>
			</tr>
			<tr>
			<td>
	...
	<tr>
		...
		<table width="100%" border="1" align="center" class="sortable">
			...
			<%
				...
				int numRecords = 0;
				try {
					currentRecord = vehicleDao.getOverSpeedData(thedate1+" 00:00:00", thedate2+" 23:59:59", vid);
			...
			<%=currentRecord.get(counter).getSpeed()%></div>
				</td>
				<td align="right"><div align="right">
				<%=currentRecord.get(counter).getDuration()%></div>
				</td>
	...
	<tr>
		...
		<table width="100%" border="1" align="center" class="sortable">
			...
			<%
						...
						int numRecords1 = 0;
						try {
							data = vehicleDao.getRapidAccelerationDetailsData(vid, thedate1+" 00:00:00", thedate2+" 23:59:59", "RapidAcceleration");
...
<%
 ...
 %>
	...
	<tr>
		...
		int numRecords2 = 0;
		try {
			data1 = vehicleDao.getRapidAccelerationDetailsData(vid,thedate1+" 00:00:00", thedate2+" 23:59:59", "RapidDecceleration");
	...
	<tr>
		...
		try {
			data3 = vehicleDao.getContinuousDrivingDetailsData(
					vid, thedate1+" 00:00:00", thedate2+" 23:59:59", "Stops");
		...
		<table width="100%" border="1" align="center" class="sortable">
			...
			try {
				data4 = vehicleDao.getContinuousDrivingDetailsData(
						vid, thedate1+" 00:00:00", thedate2+" 23:59:59", "NightDriving");
		...
		<table width="100%" border="1" align="center" class="sortable">
			...
			try {
				data5 = vehicleDao.getContinuousDrivingDetailsData(
						vid, thedate1+" 00:00:00", thedate2+" 23:59:59", "ContinuousDriving");
