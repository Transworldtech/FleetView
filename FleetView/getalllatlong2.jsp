...
conn = fleetview.ReturnConnection();;
 ...
 String rlname=session.getAttribute("rlname").toString();
 	...
 	String savedCoordiantes = "";String getCordiantesSql1 = "Select * from t_warehousedata where Owner='"+ fwUser+"' and MarkerType='Point'";
...
{
%>
<tr><th colspan="1">All Loacations for Castrol</th><th colspan="1"> <input type="button" value="ADD Record" onclick="showhide1();" class="" id="ar" ></th></tr>
...
%>
    ...
    //<![CDATA[
   		if (GBrowserIsCompatible()) 
 		{
           ...
           side_bar_html += '<td align="left"><a href="javascript:myclick(' + i + ','+lat+','+lon+')" onclick="toggleDetails('+count+',true);" onmouseover="myclick(' + i + ','+lat+','+lon+');" title="Click To See the Reports" >'+name+'</a><br><div class="popup" id="popup'+count+'"><table border="1" bgcolor="white"><tr><td><a href="#" onclick=window.open("edittrip.jsp"),"temp" javascript:toggledetails1('+count+',false);>Edit Record </a></td></tr></table></div></td></tr>'; 	
		        	//side_bar_html += '<td align="left"><a href="javascript:myclick(' + i + ','+lat+','+lon+')" onclick="toggleDetails('+count+',true);" onmouseover="myclick(' + i + ','+lat+','+lon+');" title="Click To See the Reports" >'+name+'</a><br><div class="popup" id="popup'+count+'"><table border="1" bgcolor="white"><tr><td><a href="javascript:toggleDetails('+count+',true);" onclick="window.open ("edittrip.jsp", "win1", "width=400, height=250, location=0, menubar=0, scrollbars=0, status=0, toolbar=0, resizable=0"); >Edit Record </a></td></tr><tr><td> <a href="javascript:getValue('+lat+','+lon+')" onclick="showhide3('+count+',true);" title="Click To Edit the Reports" >Delete Record </a></td></tr><tr><td> <a href="javascript:toggleDetails('+count+',false);">Close </a></td></tr></table></div></td></tr>';
...
try
{
	...
	if(OwnerName != null)
	{
	sql="select WareHouseCode,WareHouse,Owner,Latitude,Longitude,WType from t_warehousedata where Owner ='Castrol' order by WareHouse ";
	 rst=st.executeQuery(sql);
	%>
	side_bar_html += '<table border="1" class="sortable"><tr><td>Click</td><td>Sr No.</td><td>Location Code</td><td>Location Name</td>';
