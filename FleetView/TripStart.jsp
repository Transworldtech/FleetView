...
<div align="center" class="headerlay"><table style="color:#fff;"><tbody><tr><td><label id="element_1" name="element_1"  class="description" for="element_1"><font size="3"> <b>Trip Information of <%=vehno%></b> </font> </label></td></tr></tbody></table></div>
<table border="0" width="400" align="center" class="sortable_entry_new">
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><font color="red"> *</font><b>Fixed Route : </b> </label><input id="route" name="route"  class="element radio" type="radio" value="Yes" onclick="getTripInfo(this);">Yes<input id="route" name="route"  class="element radio" type="radio" value="No" checked onclick="getTripInfo(this);">No</textarea><!--1,1--></td>
<td><!--1,2--></td>
</tr>
<%
...
<td><label id="element_1_ori" name="element_1_ori"  class="description" for="element_1"><font color="red"> *</font><b>Origin :</b> </label>
<%-- <select id="stloc" name="stloc"  class="element select medium" onChange="showothloc(this);"> 
<%
...
</select>&nbsp;&nbsp;&nbsp; <!-- <input type="text" class="element text medium" name="othstrtloc" style="visibility: hidden;width: 150px" /> -->
<table border="0">
<tr>
							<td>
							<div id="routediv"></div>
...
<%
					...
					<input type="text" class="element text medium" name="othstrtloc" style="visibility: hidden;width: 150px" /></div>	
...
<%
				...
				%>
<td><label id="element_1_dest" name="element_1_dest"  class="description" for="element_1"><font color="red"> *</font><b>Destination :</b> </label>
<select id="dest" name="dest"  class="element select medium" onChange="showothdest(this);"> 
...
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><font color="red"> *</font><b>Start : </b> </label>
<input type="text" id="calender" name="calender" class="element text medium" style="width: 125px; height: 19px;" size="13" value="<%=nwfrmtdte%>" onblur="javascript:funETA();" readonly />
             ...
             <select name="sttime1" id="sttime1" class="element select small" style="width: 50px" onblur="javascript:funETA();">
						<option value="Select">Select</option>
					...
					</select> &nbsp;&nbsp;&nbsp; <%-- <input id="element_3_4" name="element_3_4"  class="datetimepicker" type="text"  value="<%=datenew3 %>" style="width: 198px;"   readonly/> --%> </textarea><br><br><!--3,1--></td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>End(ETA) : </b> </label>
<%-- <input id="element_3_5" name="element_3_5"  class="datetimepicker" type="text"  value="<%=datenew3 %>" style="width: 198px;"   readonly/> --%>
 <input type="text" class="element text medium" style="width: 125px; height: 19px;" id="etadate" name="etadate" size="13"
             ...
             Calendar.setup(
             {
                 ...
                 button      : "etadate"       // ID of the button
					...
					<select class="element select medium"  style="width: 50px;" id="etatime2" name="etatime2">
					 ...
					 <input type=text name="etatime3" id="etatime3" class="element select medium"  style="width: 30px ;display: none; readonly">
 <br><br><!--3,2--></td>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><font color="red"> *</font><b>Trip Issue :</b> </label><input id="element_3_3" name="element_3_3"  class="element text medium" type="text" value="<%=datenew1%>" size="15" readonly/>
<script type="text/javascript">
  Calendar.setup({
      inputField  : "element_3_3",         
      ifFormat    : "%d-%b-%Y",     
      button      : "element_3_3"       
    });</script> </textarea><br><br><!--2,1--></td>
    
    <td>
    <label id="element_1" name="element_1"  class="description" for="element_1"><b>Reporting : </b> </label>
<input id="calender1" name="calender1"  class="element text medium" style="width: 125px; height: 19px;" size="13" type="text"  value="<%=nwfrmtdte%>" style="width: 198px;"   readonly/> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <!--  <img src="../images/calendar.png" id="trigger" border="0"> -->
...
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Trip Type :</b> </label>
<select id="TripCategory" name="TripCategory"  class="element select medium" onChange='showothcategry(this)'> 
 <option value="Select" selected="selected">Select</option>
<%
							while (rs34.next()) {
						%>
...
<td><label id="element_1" name="element_1"  class="description" for="element_1"><font color="red"> *</font><b>Trip ID :</b> </label>
<input id="tripid" name="tripid"  class="element text medium" type="text"  value=""/>
<br><br><!--5,1-->
   </td>
</tr>
<%
				...
				%>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><font color="red"> *</font><b>Customer :</b> </label>
...
<td><label id="element_1" name="element_1"  class="description" for="element_1"><font color="red"> *</font><b>Driver Name</b> </label>
<select id="driverid" name="driverid"  class="element select medium" onChange="showothrdriverid(this);"> 
<%
				   ...
				   <label id="newid" name="newid"  class="description" style="display:none" for="element_1"><b>Driv. Id :</b> </label>
                   <!-- <label name="newid" id="newid" style="visibility: hidden">Driv. Id :</label> -->
                   <input type="text" class="element text medium" name="othdriverid" style="display:none; width: 200px" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                   <label id="newdrvname" name="newdrvname"  class="description" style="display:none" for="element_1"><b>Driv. Name :</b> </label>
                   <!-- <label name="newdrvname" id="newdrvname" style="visibility: hidden"> Driv. Name</label> -->
                   <input type="text" class="element text medium" id="newdrivname" name="newdrvname" style="display:none; width: 200px" /> </div>   <!-- </td></tr></table>  -->
<br><br><!--6,2-->
</td></tr>
<input type="hidden" name="drivername" value="<%=lastdrivername%>" readonly />

<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>LPO :</b> </label><input id="element_3_11" name="element_3_11"  class="element text medium" type="text"  value=""/></textarea><br><br><!--7,1--></td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Trailer No :</b> </label><input id="element_3_12" name="element_3_12"  class="element text medium" type="text"  value=""/></textarea><br><br><!--7,2--></td>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Customer Cont. Person :</b> </label><input id="element_3_13" name="element_3_13"  class="element text medium" type="text"  value=""/></textarea><br><br><!--8,1--></td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Customer Cont. No :</b> </label><input id="element_3_14" name="element_3_14"  class="element text medium" type="text" /></textarea><br><br><!--8,2--></td>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Container No :  </b> </label>
<input id="containerno" name="containerno"  class="element text medium" type="text"  value=""/>
<br><br><!--9,1-->
</td>
<td>
<label id="element_1" name="element_1"  class="description" for="element_1"><b>Job Order No :</b> </label>
<input id="joborderno" name="joborderno"  class="element text medium" type="text"  value=""/>
<br><br><!--9,2-->
</td>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Container Type :</b> </label>
<input id="element_3_17"  name ="element_3_17" type="text" value="" class="element text medium" >
<!-- <select id="element_3_17" name="element_3_17"  class="element select medium" > 
<option value="select" selected="selected">select</option><option value="Z">Z</option><option value="B">B</option></select> --></textarea><br><br><!--10,1--></td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Revenue :</b> </label>
<input id="revenue" name="revenue"  class="element text medium" type="text"  value=""/></textarea><br><br><!--10,2--></td>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Token No :</b> </label><input id="element_3_19" name="element_3_19"  class="element text medium" type="text"  value=""/></textarea><br><br><!--11,1--></td>
<td>
...
<option value="B">B</option><option value="C">C</option></select>
 -->
 <label id="element_1" name="element_1"  class="description" for="element_1"><b>Token Charges Paid :</b> </label><input id="element_3_20" name="element_3_20"  class="element text medium" type="text"  value=""/>
 </textarea><br><br><!--11,2--></td>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Sales Person :</b> </label>
<input id="element_3_21" name="element_3_21"  class="element text medium" type="text"  value=""/>

 </textarea><br><br><!--11,2--></td>
<!-- <select id="element_3_21" name="element_3_21"  class="element select medium" > 
<option value="select" selected="selected">select</option><option value="A">A</option><option value="B">B</option><option value="C">C</option></select> --></textarea><br><br><!--12,1--></td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Container Status :</b> </label><select id="element_3_22" name="element_3_22"  class="element select medium" > 
<option value="select" selected="selected">select</option>
<option value="-">-</option>
<option value="Import">Import</option>
<option value="Export">Export</option>
</select></textarea><br><br><!--12,2--></td>
</tr>
...
<%
				...
				%>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Load Delay Reason :</b> </label>
<select id="Loadreason" name="Loadreason"  onChange="showothLoadreason(this);" class="element select medium" > 
<option value="Select">Select</option>
...
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Weight Load</b> </label>
<input id="weight" name="weight"  class="element text medium" type="text"  value=""/><font size="2"> Kg. </font>
</textarea><br><br><!--14,1-->
</td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b> Freight :</b> </label>
<input id="frie" name="frie"  class="element text medium" type="text"  value=""/><font size="2">Rs.</font>
<br><br><!--14,2--></td>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>CN :</b> </label>
<input id="cnnumber" name="cnnumber"  class="element text medium" type="text"  value=""/>
<br><br><!--15,1-->
</td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Advance :</b> </label>
<input id="adv" name="adv"  class="element text medium" type="text"  value=""/><font size="2">Rs.</font>
<br><br><!--15,2--></td>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Branch Office Code :</b> </label>
<input id="bcode" name="bcode"  class="element text medium" type="text"  value=""/>
</textarea><br><br><!--16,1--></td>
...
<%
				...
				%>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Product Name :</b> </label>
<select id="GoodsContent" name="GoodsContent"  class="element select medium" onChange='showothcontent(this)'> 
<option value="Select">Select</option>
...
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>LR Issued By :</b> </label>
<input id="lrissue" name="lrissue"  class="element text medium" type="text"  value=""/></textarea><br><br><!--17,1--></td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b> LR Contact :</b> </label>
<input id="lrcontact" name="lrcontact"  class="element text medium" type="text"  value=""/></textarea><br><br><!--17,2--></td>
</tr>
<tr>
<td id="fx01"><label id="element_1" name="element_1"  class="description" for="element_1"><b>Fixed KM :</b> </label>
<input id="fxdkm" name="fxdkm"  class="element text medium" type="text"   />
<br><br><!--18,1--></td>
<td id="fx10"><label id="element_1" name="element_1"  class="description" for="element_1"><b>Rate/Km</b> </label>
<input id="ratekm" name="ratekm"  class="element text medium" type="text"   onblur="validateRatekm()" value=""/></textarea><br><br><!--18,2--></td>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Rate/Hr. :</b> </label>
<input id="ratehr" name="ratehr"  class="element text medium" type="text"   />
</textarea><br><br><!--19,1--></td>
<td id="fx12"><label id="element_1" name="element_1"  class="description" for="element_1"><b>Fixed Time :</b> </label>
<input id="ftme" name="ftme"  class="element text medium" type="text"    value=""/><font size="2">Hrs.</font>
</textarea><br><br><!--19,2-->
<input type="button" name="Computetripexpence" value="Compute Trip Expense" style="border-style: outset; border-color: black" onClick="return computetripexpence123()" class="formElement" />
</td>
...
<tr>
<td id="fx9"><label id="element_1" name="element_1"  class="description" for="element_1"><b>Trip Expense :</b> </label>
<input id="tripexp" name="tripexp"  class="element text medium" type="text"  value="" readonly="readonly"/>
</textarea><br><br><!--21,1-->
<input type="button" name="Compute ETA" value="Compute ETA" style="border-style: outset; border-color: black" onClick="return computrtriptime()" class="formElement" /><br><br>
</td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>CN File Upload :</b> </label> 
<input type="file" cols="40" name="Filename1" id="Filename1" value="" onchange="upload();" />
...
<input id="f6" name=f6 class="element text medium" type="text" maxlength="255" value="" style="width: 150px; height: 20px;display: none;"/></td>
</tr>
<tr>
	    <td> 
	     <label id="element_1" name="element_1"  class="description" for="element_1"><b>Comment :</b> </label> 
