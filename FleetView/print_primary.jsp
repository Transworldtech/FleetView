				...
				//	System.out.println(sqll1);
					...
					while(rstt1.next())
					{
						...
						vehcountall=vehcountall+rstt1.getInt("Vehid");
								...
								String zsqlg="select count(TripID) as Trip from t_CastrolTripsEnded where TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='primary'    and   KmTraveled>'0'  and  (OSCount>'0' or RACount>'0' or RDCount>'0')     and StartPlace='"+startplace+"'";
				...
				<td  class="hed"> Rating</td>
					...
					while(rstt.next())
					{
						...
						vehcountall=vehcountall+rstt.getInt("Vehid");
								...
								String zsqlg1="select Transporter,count(TripID) as Trip from t_CastrolTripsEnded where TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='primary'   and  KmTraveled<>'0'  and (OSCount>'0' or RACount>'0' or RDCount>'0')   and Transporter='"+startplace+"'";
								//System.out.println(sqll);
				...
				//	System.out.println(sqll);
					...
					while(rstt.next())
					{
						...
						vehcountall=vehcountall+rstt.getInt("Vehid");
								...
								String zsqlg2="select count(TripID) as Trip from t_CastrolTripsStarted where TripStartDate  between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='primary'    and   KmTraveled<>'0' and  (OSCount>'0' or RACount>'0' or RDCount>'0')     and StartPlace='"+startplace+"'";
				...
				//	System.out.println(sqll);
					...
					while(rstt.next())
					{
						...
						vehcountall=vehcountall+rstt.getInt("Vehid");
								...
								String zsqlg3="select Transporter,count(TripID) as Trip from t_CastrolTripsStarted where  TripStartDate  between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59'  and Category='primary'   and KmTraveled<>'0'  and (OSCount>'0' or RACount>'0' or RDCount>'0')   and Transporter='"+startplace+"'";
			...
			//	System.out.println(sqll);
				...
				while(rstt.next())
				{
					...
					vehcountall=vehcountall+rstt.getInt("Vehid");
							...
							String	zsqlg3="select Transporter,count(TripID) as Trip2 from t_CastrolTripsStartEnded where TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59'  and Category='primary'    and  KmTraveled<>'0'  and (OSCount>'0' or RACount>'0' or RDCount>'0')  and StartPlace='"+startplace+"'";
							//System.out.println(sqll);
					...
					//	System.out.println(sqll);
						...
						while(rstt.next())
						{
							...
							vehcountall=vehcountall+rstt.getInt("Vehid");
									...
									String	zsqlg="select Transporter,count(TripID) as Trip2 from t_CastrolTripsStartEnded where  TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59'  and Category='primary'   and  KmTraveled<>'0' and (OSCount>'0' or RACount>'0' or RDCount>'0')  and Transporter='"+startplace+"'";
									//System.out.println(sqll);
