...
<div class="bodyText" align="right">
		...
		<a href="excel_details_custom_report.jsp?vehcode=<%=VehicleCode%>&data=<%=fromdate%>&data1=<%=todate%>&fromtime=<%=fromtime%>&totime=<%=totime%>&interval=<%=interval1%>&chbx=<%=chbxAll %>&chbx1<%=chbxAll1 %>" title="Export to Excel">
