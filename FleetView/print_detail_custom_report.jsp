...
<table border="0" width="100%" bgcolor="white">
<tr align="center" >
<td colspan="9"><div align="center"><font size="3">
...
<%
String sqlnew="select * from t_veh"+VehicleCode+" where concat(TheFieldDataDate,' ',TheFieldDataTime) <='"+datenew1+" "+fromtime+"' order by concat(TheFieldDataDate,' ',TheFieldDataTime) desc limit 1";
...
while(rst1.next())
{
	...
	%>
					...
					<tr>
												...
												<td class="bodyText"><div align="right">&nbsp;&nbsp;<%=speedsi%></div></td>
												<%if(session.getAttribute("distformat").toString().equalsIgnoreCase("ML"))
												{
												 %>
	...
	%>
									...
									i++;
											...
											<tr>
												<td class="bodyText"><div align="right"><%=i%></div></td>
												<td class="bodyText"><div align="left"><%=new SimpleDateFormat(dateformat+" HH:mm:ss").format(dt2)%></div></td>
												<td class="bodyText"><div align="right">&nbsp;&nbsp;<%=speedon%></div></td>
												<%
