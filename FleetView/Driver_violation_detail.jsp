...
<tr>		 
	...
	<table width="100%" border="1" align="center">
		<tr align="center">
			...
			<th> <b>Castrol Trips</b></th>
		</tr>	
		
		<% 
		String str = "SELECT * FROM `t_CastrolDrivers6` WHERE TheDte BETWEEN '"+ date1 + "' AND '"+ date2 + "' AND Duration > '10:00:00' and DriverID = '"+DriverID+"'"; 
		...
		while(myrst.next())
		 {
			...
			<td> <div align="center"><%=myrst.getString("Distance") %></div></td>
			<td> <div align="center"><%=myrst.getString("Duration") %></div></td>
			<td> <div align="center"><%=myrst.getString("CastrolTrip") %></div></td>
			<%	
			 count++;
