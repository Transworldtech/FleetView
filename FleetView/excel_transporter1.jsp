...
<% 
	...
	String filename=session.getAttribute("user").toString()+showdatex+"CastrolDriverwiseTotalTrips_Report.xls";
...
nf.setGroupingUsed(false);
	...
	%>
	<font size="2"><b><center>Trips Report for <%=startplace%> from <%=data%> to <%=data1%></center></b></font>
