...
String ratingfrmtd="", ncastratingfrmtd="";
	...
	sql1="select sum(OSCount) as OS, sum(RACount) as RA, sum(RDCount) as RD, sum(Distance) as Distance, avg(Rating) as Rating from t_driver_ds where Jcode ='-' and DCode='"+driverid+"' ";
	oscount1=0;
	racount1=0;
	rdcount1=0;
	distance1=0;
