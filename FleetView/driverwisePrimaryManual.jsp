...
<tr><td align="left"><div align="left"><font size="3" >Report No: 10.24.1</font></div></td></tr>
<tr><td>
<%
...
<div align="right">
				<a href="#" onclick="javascript:window.open('print_transporterprimarymanual.jsp?startplace=<%=startplace.replace("&","and")%>&date1=<%=data %>&date2=<%=data1 %>&triptype=<%=triptype%>');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; 
				<a href="excel_transporterprimarymanual.jsp?startplace=<%=startplace.replace("&","and")%>&date1=<%=data %>&date2=<%=data1 %>&triptype=<%=triptype%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>
