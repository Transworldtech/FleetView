...
String trip1=request.getParameter("tripid"); 
...
<td ><div align="right">
<font size="2"><%=tripID%></font><br/>
</div></td>
<td ><div align="left"><%=rst.getString("DriverName")%> <%="("+rst.getString("DriverId")+")"%></div></td>
<td  text-align: left"><%=rst.getString("VehRegNo")%></td>
<td  text-align: left"><%=rst.getString("OwnerName")%></td>
<td  text-align: left"><%
try{ 
...
%></td>
<td  text-align: left"><%=rst.getString("StartPlace")%></td>
<%
double lat,lon;
...
%>
<td  text-align: right"><%=rst11.getString("Latitude")%></td>
<td  text-align: right"><%=rst11.getString("Longitude")%></td>
<%
}
else
{
...
{
%>
<td  text-align: right"><%=rstg.getString("Startlat")%></td>
<td  text-align: right"><%=rstg.getString("Startlong")%></td>
<%
}
else
{
...
%>
<td  text-align: right"><%=rstg.getString("Endlat")%></td>
<td  text-align: right"><%=rstg.getString("Endlong")%></td>
<%
}
else
{
...
%></td>
<td  text-align: left"><%=rst.getString("EndPlace")%></td>
<%
...
//slon=rst11.getString("Longitude");
%>
<td  text-align: right"><%=rst12.getString("Latitude")%></td>
<td  text-align: right"><%=rst12.getString("Longitude")%></td>
<%
}
else
{
...
%>
<td  text-align: right"><%=rstdist.getString("Km")%></td>
<td  text-align: right"><%=rstdist.getString("TTime")%></td>
<%
}
else
{
...
String ss6="select Category from t_alljddata where TripId='"+tripID+"'";
	...
	{%>
		...
		<td  text-align: left"><%=rs6.getString("Category")%></td>
<% }
...
{%>
<td  text-align: right"><%="Not Attended" %></td>
<%
...
<td  text-align: left"><%=endComments %></td>
<td  text-align: left"><a href="javascript: flase" onClick="window.open ('tripcomment.jsp?tripid=<%=tripID%>&vehcode=<%=rst.getString("VehId")%>&vehno=<%=rst.getString("VehRegNo")%>', 'win1', 'width=600, height=350, location=0, menubar=0, scrollbars=0, status=0, toolbar=0, resizable=0');"><%=finalComment %></a></td>
</tr>
<%
}
%>
