...
<table border="0" width="100%" >
	  <tr>
		<td colspan="15">  <div align="center"> <font color="blue" size="3"> <B> Km Details for 
<%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(fromdate))%> </B> </font></div> 	
	...
	<table border="0" width="100%" class="bodyText" bgcolor="white">
	  ...
	  <tr bgcolor="#DCDCDC">
		<td class="bodyText">  <div align="center"> <font color="maroon" size="1"> <B> Sr No </B> </font> </td>
	...
	<td>
		 <table border="0" width="100%" >
	  	 <tr>
		   <td>  <div align="center"> <font color="maroon"> <B> As per EXL </B> </font>
		 </div> </td>
 		 </tr>
		<tr>
		    <table border="0" width="100%" >
	  	     <tr>
		       <td  align="center" width="33%" class="bodyText"> <font color="maroon"><B>Kms  </font></td>
...
%>	
	<tr><td align="center" colspan="15"><input type="button" name="Print" value="Print" onclick="javascript:window.print();" class="formElement"></td></tr>
