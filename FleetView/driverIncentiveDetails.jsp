...
String exportFileName=session.getAttribute("user").toString()+"_DriverIncentiveForPrimaryAndSecondaryReport.xls";  
		 ...
		 <table style="width: 500px;">
			...
			<tr align="center"  >
				 <td align="center" colspan="3" >
					<a href="IncentivePaymentReportAll.jsp" target="_blank"> <font size="2" face="Arial"><b> Driver Incentive Payment Report For All Drivers</a></b></font>
...
<font face="Arial">	Driver Incentive Report For Primary And Secondary Trips From  <%=new SimpleDateFormat("MMM-yyyy").format(new SimpleDateFormat("MM-yyyy").parse(Mon+"-"+Yer))  %>  To <%=new SimpleDateFormat("MMM-yyyy").format(new SimpleDateFormat("MM-yyyy").parse(Mon1+"-"+Yer1))  %></font></div>
...
<tr>
       ...
       <br>
          ...
          <a href="DriverIncentivePriSecExcel.jsp?data1=<%=Mon%>&data2=<%=Yer%>&data3=<%=Mon1%>&data4=<%=Yer1%>" title="Export to Excel">
...
<th style="width: 50px">Unpaid Amount</th>
</tr>
<%
...
<a href="driverIncentiveShowTrips.jsp?driverid=<%=rs.	getString("driverid")%>&category=prisec&month=<%=QueryDate%>&month1=<%=QueryDate1 %>" target="_blank"><%=rs.getString("driverid") %>
</a>
</td>
