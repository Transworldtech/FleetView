...
<% 
	...
	String filename=session.getAttribute("user").toString()+showdatex+"CastrolNDSecondaryTrip_Report.xls";
...
<% nf.setMaximumFractionDigits(2);
  ...
  // System.out.println("frmdate---"+data1);
  // System.out.println("todate----"+data2);
	   ...
	   if(!(null==triptype))
		{
				...
				{
					%>
					<tr><td><font size="2"><b><center>Report for ND Secondary Trips from <%=data1%> to <%=data2 %></center></b></font></td></tr>
				...
				{
					%>
					<tr><td><b><font size="2"><b><center>Report for ND Secondary Trips from <%=data1%> to <%=data2%> </center></b></font></td></tr>
		...
		if(triptype.equalsIgnoreCase("started"))
		{
			...
			while(rstt.next())
			{
				...
				vehcountall=rstt.getInt("Vehid");
						...
						String sqlall="Select * from t_CastrolTripsStarted where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='Secondary' and status<>'Faulty' and ND='Yes'";
