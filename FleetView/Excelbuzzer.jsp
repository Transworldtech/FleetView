...
try{
	...
	String todey=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new java.util.Date());
...
<tr><td colspan="5" align="center"><b><font size="3" color="maroon"> Crane Overload Alarm Report of Crane <%=cranemodno%> </td>
</tr>
<tr><td colspan="5">
