...
function showhide1()
{
	...
	//	document.getElementById("print").innerHTML='<a href="#" onclick="javascript:window.open(\'printmoving.jsp?tdx=hide\');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>';
	//	document.getElementById("excel").innerHTML='<a href="excelmoving.jsp?&tdx=hide" title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>';
	//	document.getElementById("print").innerHTML='<a href="#" onclick="javascript:window.open(\'GenericPrint.jsp?&sessiondata=VehiclePositionsViewData&key=ALL&condition=HideTripInfo\');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>';
	//	document.getElementById("excel").innerHTML='<a href="GenericExportExcel.jsp?&sessiondata=VehiclePositionsViewData&key=ALL&condition=HideTripInfo" title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>';
	}
	else
	{
		for(i=0;i<=cnt;i++)
	...
	//	document.getElementById("print").innerHTML='<a href="#" onclick="javascript:window.open(\'printmoving.jsp?tdx=show\');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>';	
	//	document.getElementById("excel").innerHTML='<a href="excelmoving.jsp?&tdx=show"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>';
	//	document.getElementById("print").innerHTML='<a href="#" onclick="javascript:window.open(\'GenericPrint.jsp?&sessiondata=VehiclePositionsViewData&key=ALL&condition=ShowTripInfo\');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></img></a>';	
	//	document.getElementById("excel").innerHTML='<a href="GenericExportExcel.jsp?&sessiondata=VehiclePositionsViewData&key=ALL&condition=ShowTripInfo"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></img></a>';
	}
}
...
function showPrint()
{
	...
	window.open("GenericPrint.jsp?&sessiondata=VehiclePositionsViewData&key=Moving&condition="+condition);
...
function showExcel()
{
	...
	window.open("GenericExportExcel.jsp?&sessiondata=VehiclePositionsViewData&key=Moving&condition="+condition);
...
<jsp:include page="SubUserView.jsp">
	...
	<table border="0" width="100%" align="center"> 
		...
		<input type="button" value="Hide Trip Info" onclick="showhide1();" class="formElement" id="tdx" name="tdx" ></td>
		
		
	<!--<td bgcolor="#FFFFFF" id="print">
			<a href="#" onclick="javascript:window.open('printmoving.jsp?&tdx=show');" 
				title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp;</td>-->
			<!--<td bgcolor="#FFFFFF" id="excel">
			<a href="excelmoving.jsp?&tdx=show"  
				title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>&nbsp;&nbsp;</td>-->
...
<%
	try {
		 	int i = 1;
		 	String today=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new java.util.Date());
			...
			//out.println(currentRecord.getSpeed());
				if((("-".equalsIgnoreCase(currentRecord.getSpeed())) || Double.parseDouble(currentRecord.getSpeed())<=0)) {
					continue;
				}
				else if(Double.parseDouble(currentRecord.getSpeed())>0 && currentRecord.getLocationWithDeviceStatus().contains("Device Disconnected")){
					continue;
				}
				else if(Double.parseDouble(currentRecord.getSpeed())>0 && currentRecord.getLocationWithDeviceStatus().contains("Device DeActivated")){
					continue;
				}
%>	
		<tr>
...
%>						
			...
			<td style="<%=currentRecord.getBgColor()%>"><%=currentRecord.getSpeed()%></td>
<%
...
%>		   				
		   				<tr>
				   			<td><a href="edittrip.jsp?vehno=<%=currentRecord.getVehicleRegistrationNo()%>
				   							...
				   							&tripid=<%=currentRecord.getTripID()%>">Edit Trip </a>
							</td>
						</tr>
<%
				}
...
%>
			<td id="tdd<%=i%>" style="<%=currentRecord.getBgColor()%>">
				<a href="tripstart.jsp?vehno=<%=currentRecord.getVehicleRegistrationNo()%>"><%=currentRecord.getTripID()%></a>
			</td>
			<td id="tde<%=i%>" style="<%=currentRecord.getBgColor()%>">
