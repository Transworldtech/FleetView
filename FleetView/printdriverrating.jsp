...
<%
String sql2="select * from t_driver_ds where TheDate='"+data2+"' and Distance between 100 and 250 and Jcode <>'-'  and transporter in "+trans+" order by Rating desc, Distance desc limit 20";
...
<%
sql="select * from t_driver_ds where TheDate='"+data2+"' and Distance > 250 and Distance < 500  and Jcode <>'-' and transporter in "+trans+" order by Rating desc, Distance desc limit 20";
