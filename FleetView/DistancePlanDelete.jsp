...
%>
<%
String routeid="",distance="",rid="",Km="",Balance="";
...
try
{
	...
	String sql = "delete from  db_gps.t_dtwisefuelplan where routeid='"+routeid+"' and distance = '"+distance+"' and ID = '"+rid+"' and owner='"+owner+"' ";
	//st.execute(sql);
