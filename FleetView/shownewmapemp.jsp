...
<%@page import="com.fleetview.beans.classes"%><html>
<head>
...
<%!
String latitude,longitude,discription,empname;
%>
<%
...
String sql="select * from t_targetpage where typevalue='"+usertypevalue+"'";
