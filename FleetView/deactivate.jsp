...
<form name="CountOfRecordsForm">
		<input type="hidden" name= "cnt" id="cnt" value=<%=numRecords%>></input>
			...
			<tr>
			<td align="center">
			<!-- <div align="left"><font size="3">Report No:1.5</font></div>-->
			<div><font size="3"> <b>Device Deactivated Vehicle </b></font></div>
				<div align="right">
				<!--<a href="#" onclick="javascript:window.open('printdeactivate.jsp');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>-->&nbsp; &nbsp; 
				<!--<a href="exceldeactivate.jsp"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>-->
				<a href="#" onclick="javascript:window.open('GenericPrint.jsp?&sessiondata=VehiclePositionsViewData&key=Device Deactivated&condition=deactivate');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; 
				<a href="GenericExportExcel.jsp?&sessiondata=VehiclePositionsViewData&key=Device Deactivated&condition=deactivate"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>
				<%=Utilities.printDate() %>
				</div>
			</td>
			</tr>
...
<%
			try {
					...
					if(currentRecord.getDeviceStatus().equalsIgnoreCase("Device Deactivated"))
					{
%>
					<tr>
						<td style="background-color:#EEC5C8;"><%=i%></td>	
						<td style="background-color:#EEC5C8""><%=currentRecord.getVehicleRegistrationNo()%></td>	
						<td style="background-color:#EEC5C8;"><%=currentRecord.getInstalledDate() %></td>
						<td style="background-color:#EEC5C8;"><%=currentRecord.getInstalledPlace()%></td>	
<%					i++;
					}
