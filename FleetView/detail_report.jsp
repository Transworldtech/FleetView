...
String sql1="select * from t_vehicledetails where VehicleCode='"+VehicleCode+"'";
	...
	//String sql="select * from t_veh"+VehicleCode+" where TheFieldDataDateTime>='"+fff+"' and TheFieldDataDateTime<='"+ttt+"' and TheFiledTextFileName in('SI','DO','DS') order by concat(TheFieldDataDate,TheFieldDataTime) asc";
	String sql="select * from t_veh"+VehicleCode+" where TheFieldDataDateTime>='"+fff+"' and TheFieldDataDateTime<='"+ttt+"' and TheFiledTextFileName in('SI','ON','OF') order by TheFieldDataDateTime asc";
