		...
		<td  class="hed"> Rating</td>
			...
			while(rstt.next())
			{
				...
				vehcountall=vehcountall+rstt.getInt("Vehid");
						...
						String sql14="Select count(Debriefing) as dbcount1 from t_CastrolTripsEnded where Debriefing='Yes' and TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and status<>'Faulty' and StartPlace='"+startplace+"'";
		...
		//	String sqltrip="SELECT Distinct(`TripID`) FROM t_alljddata WHERE `StartDate` between '"+fromdate+"' and '"+todate+"' and Status <> 'NotProcessed'";
			...
			while(rstt.next())
			{
				...
				vehcountall=vehcountall+rstt.getInt("Vehid");
						...
						String zsqlg1="select Transporter,count(TripID) as Trip from t_CastrolTripsEnded where TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and status<>'Faulty' and(OSCount>'0' or RACount>'0' or RDCount>'0') and KmTraveled<>'0'   and Transporter='"+startplace+"'";
						//System.out.println(sqll);
						...
						String zsql="select count(TripID) as Trip from t_CastrolTripsEnded where TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and status<>'Faulty'  and OSCount='0' and RACount='0' and RDCount='0' and KmTraveled<>'0'    and Transporter='"+startplace+"'";
						//System.out.println(sqll);
...
///************************************************STARTED**********************************************************************************************	
	else if(thename.equalsIgnoreCase("started"))
	{
		...
		//System.out.println("Start....");
			...
			{  
				System.out.println("TransporterWise For saterted Trips");
				///*********************** **************TRANSPORTER *****
			%>
			<table border="1" width="100%" class="sortable">
		<tr>
