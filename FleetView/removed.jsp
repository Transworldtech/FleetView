...
<form name="CountOfRecordsForm">
		<input type="hidden" name= "cnt" id="cnt" value=<%=numRecords%>></input>
			...
			<tr>
			<td align="center">
			<!-- <div align="left"><font size="3">Report No:1.4</font></div>-->
			<div><font size="3"> <b>Device Removed Vehicle </b></font></div>
			
			<!--<div align="right">
				<a href="#" onclick="javascript:window.open('printremoved.jsp');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; 
				<a href="excelremoved.jsp"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>
				<%//=Utilities.printDate() %>
				</div>-->
			
				<div align="right">
				<a href="#" onclick="javascript:window.open('GenericPrint.jsp?&sessiondata=VehiclePositionsViewData&key=Device Removed&condition=removed');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; 
				<a href="GenericExportExcel.jsp?&sessiondata=VehiclePositionsViewData&key=Device Removed&condition=removed"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>
				<%=Utilities.printDate() %>
				</div>
			</td>
			</tr>
...
<%
			try {
					...
					if(currentRecord.getDeviceStatus().equalsIgnoreCase("Device Removed"))
					{
%>
					<tr>
						<td style="background-color:#BDEDFF;"><%=i%></td>	
						<td style="background-color:#BDEDFF;"><%=currentRecord.getVehicleRegistrationNo()%></td>	
						<td style="background-color:#BDEDFF;"><%=currentRecord.getInstalledDate() %></td>
						<td style="background-color:#BDEDFF;"><%=currentRecord.getInstalledPlace()%></td>	
<%						i++;
					}
