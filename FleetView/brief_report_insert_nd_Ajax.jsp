...
sql="update db_gpsExceptions.t_vehall_nd set ClosingComment='"+otherreason+"', violationstatus='Close',Closedatetime='"+sysdate22+"',ClosedBy='"+userid+"' where VehCode='"+vehid+"' and  FromDatetime='"+date+"'";
