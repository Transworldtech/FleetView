...
sql1="select count(distinct(TripId)) as tpcount from t_completedjourney where StartDate >='"+data1+"' and StartDate <='"+data2+"' and TripId <>'-' and OwnerName='"+transporter+"'  and Gpname='Castrol'";
