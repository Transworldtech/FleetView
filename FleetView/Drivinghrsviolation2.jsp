...
<%!
	...
	Statement st4,st1,st2,st5,stv,std;
...
try
{
	...
	//String Transporter=session.getAttribute("usertypevalue").toString();
            ...
            <tr style="border:none"><td><font color="block" size="3" >Report No: 10.30</font></td></tr>
	         ...
	         <a href="excel_drivinghrs2.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
	         &nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.open('print_drivinghrs2.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>
		...
		//	java.util.Date lastdate=new java.util.Date();
			String lastdate,nextday;
				...
				String sql="";
			       ...
			       String	sql2= "select JCode,count(*) as countTrip from t_driver_ds  where TheDate between '"+fromdate+"' and '"+todate+"' and GPName='Castrol'  and RDurationinHrs>='10' and  JCode<>'-' group by JCode ";
		           ResultSet vset=st4.executeQuery(sql2); 
		           while(vset.next())
		             {
		            	   countTrip=vset.getInt("countTrip");       
			            	 ...
			            	 if(countTrip>1)
		                      ...
		                      String jcode=vset.getString("JCode");
	...
	else if(thename.equalsIgnoreCase("started"))
	{
		...
		//	java.util.Date lastdate=new java.util.Date();
			String lastdate,nextday;
				...
				<td><b>Duration(Hrs)</b></td>
				<td><b>CastrolTrip</b></td>
				<td><b>Prev Km Traveled</b></td>
				<td><b> Prev day Duration(Hrs)</b></td>
				<td> <b>Prev day CastrolTrip</b></td>
				<td> <b> Nxet day Km Traveled</td>
				<td><b>Nxet day Duration(Hrs)</td>
				<td><b>Nxet day CastrolTrip </td>
				<td><b>Total Km Traveled</b></td>
				<td><b>Total Duration(Hrs)</b></td>
				<td><b>Castrol Days</b></td>
				</tr>
