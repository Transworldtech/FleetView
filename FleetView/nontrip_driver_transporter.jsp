...
%>
<table class="stats">
<tr><th colspan="11"><font size="3" face="Arial">Driver wise Non-trips Exception Report for <%=transporter%> from <%
...
out.print(showdate1);
%>. </font><div align="right" ><a href="#" onclick="javascript:window.open('printnontrip_driver_transporter.jsp?data1=<%=data1%>&data2=<%=data2%>&transporter=<%=transporter%>');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; <a href="excelnontrip_driver_transporter.jsp?data1=<%=data1%>&data2=<%=data2%>&transporter=<%=transporter%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>&nbsp;&nbsp;&nbsp;Date : <%
Format fmt = new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss");
String sdt = fmt.format(new java.util.Date());
 out.print(sdt); %></div></th></tr>
 </table>
 <div align="center">
<table class="sortable" style="width: 800px;" align="center">
<tr>
<td class="hed"><div align="center">Driver Name(Code)</div></td>
<td class="hed"><div align="center">Veh.</div></td>
