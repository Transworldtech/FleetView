...
//			alert(vehicle);
			...
			document.getElementById("myIframe").src="http://myfleetview.com:8080/birttest/frameset?__report=vehtag_report.rptdesign&vehlist="+userid+"&__showtitle=false";
...
<!-- JavaScript for export to excel and export to PDF -->  
	...
	<table border="0" width=600 align="center" class="stats">
		<tr>
			...
			<font face="Arial" color="black" size="3"><b style= "font:normal 16px Arial,Helvtica,sans-serif;"><b> Vehicle Tagging Report</b></font></td>
		</tr>
	</table>
...
dt1=dt1+" 23:59:59";
	...
	<div id="reportData" align="center">
	
<iframe id="myIframe" width="58%" height="850px" src="http://myfleetview.com:8080/birttest/frameset?__report=vehtag_report.rptdesign&vehlist=<%=UserID%>&__showtitle=false"> 
...
window.onload=birt;
 ...
 -->
	...
	<%-- <%
		String exportFileName = "VehilceOfflineReport.xls";
	%> --%>
...
<!-- Table for  Export to Excel and PDF -->
	...
	<div id="mytable" align="Center">   <!-- Dont change this div -->
...
%> --%>
		...
		String vehno="";
		String alertstatus="",datetime="";
		String sql="select H.VehCode,D.VehicleRegNumber,   H.VehIdleAlertStatus, H.updatedDateTime from db_gps.t_VehicleIdleAlertHistory H, db_gps.t_vehicledetails D where H.VehCode in "+session.getValue("VehList").toString()+" and H.updatedDateTime>='"+data1+" 00:00:00' and H.updatedDateTime<='"+data2+" 23:59:59' and H.VehCode=D.VehicleCode order by updatedDateTime desc ";
		System.out.println("Sql "+sql);
		ResultSet rs=st.executeQuery(sql);
		while(rs.next())
		{
			
			vehno=rs.getString("VehicleRegNumber");
			alertstatus=rs.getString("VehIdleAlertStatus");
			datetime=rs.getString("updatedDateTime");
			...
			<td style="text-align: left;font:normal 13px Arial,Helvtica,sans-serif;">Online </td>
			<%}else {%>
			<td style="text-align: left;font:normal 13px Arial,Helvtica,sans-serif;"><%= alertstatus%> </td>
			<%} %>
			<td style="text-align: right;font:normal 13px Arial,Helvtica,sans-serif;"><%= new SimpleDateFormat("dd-MMM-yyyy hh:MM").format(rs.getDate("updatedDateTime"))%></td>
