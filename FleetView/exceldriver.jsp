...
<body>
<form id="drivermgt" name="drivermgt" action="">
<div style="margin-left: 400px">
		<table border="0" align="center">
		<tr><td align="center"><div align="center"><font face="Arial" size="3"><b>Report For Driver Management</b></font></div></td></tr>
...
<tr>
<td align="right"><%=i%></td>
<td align="right"><%=rs.getString("DriverID") %></td>
...
<td align="left"><%=rs.getString("ACTIVESTATUS") %></td>
<%
	...
	%>
					<td align="left" style="width: 10%"><div align="left">NA</div></td>
...
<%
	...
	%>
	<%
	if(newaddfile=="" || newaddfile.equals("") || newaddfile.equals("-"))
	{
	%>
					<td align="left">NA</td>
