...
<tr align="center">
<td>
<!-- <div align="left"><font size="3"><b>Report No:1.2</b></font></div>-->

 <div align="center"><font size="3"><b>Report For GenSet Start Time<b></font></div>
</td>
</tr>
</table>
...
//	       out.println("change date="+ddate1);
						...
						//	System.out.println("sql3==>"+sql3);
							...
							while(rs3.next())
							{
								...
								//-------------------------------------------------------------------------
							     ...
							     rw_cnt=rs3.getRow();   
							     		stat=rs3.getString("Sen1");
									     if(stat.equals("OF"))
									     {
									    	flg="Y"; 
									     }
									     if(stat.equals("ON") && rw_cnt==1)
									     {
									    	 //---------------------------------------------------
									    	 flg="N";
									    	 ccnt++;
				    						...
				    						<td align="left"><div align="left"><%=onof%></div></td>
				    						</tr> 			
									    	<%		            
				    							sr_no++;
				    							 }
...
//							 }
			...
			<tr><th id="tdp0" >No Records For Selected Date</th></tr>
						</table>
						<%
					}
	                   %>
