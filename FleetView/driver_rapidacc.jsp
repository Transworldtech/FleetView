...
String data1,data2,vid,vehno,sdate,edate,showdate,showdate1,tripid;
...
Connection conn;
 ...
 //	vid=session.getAttribute("vid").toString();
	...
	try{
		...
		String sql="select * from "+tbname+" where concat(TheDate,' ',TheTime)>='"+sdate+"' and concat(TheDate,' ',TheTime)<='"+edate+"' and VehCode='"+vid+"'";
