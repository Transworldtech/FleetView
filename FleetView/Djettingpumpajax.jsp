...
<%!
Connection con1;
Statement st,st1,st2,st3,st4,st5,st17,st11;
ResultSet rst1=null;
int cnt=0,cnt1=0;
...
try {
    ...
    //out.println("expence:-"+expence);
//     expence=expence.replace(""," ");
    System.out.println("expence after:-"+expence);
...
// 	String strstr=vvv.replace("-"," ");
	System.out.println("STRSTR:-"+expence);
	
String abc="select field from db_gps.t_jettingpumpforcustomfieldmaster where field='"+expence+"' ";
...
if(rst2.next( ))
{
  ...
  String insrtmaster="insert into db_gps.t_jettingpumpforcustomfieldmaster(Entryby,Owner,field) values('"+user+"','"+transporter+"','"+expence+"') ";
  cnt=st1.executeUpdate(insrtmaster);
  
  String insrtmaster1="insert into db_gps.t_jettingpumpforcustomfieldmasterhistory(Entryby,Owner,field) values('"+user+"','"+transporter+"','"+expence+"') ";
  cnt=st17.executeUpdate(insrtmaster1);
...
//System.out.println("fulmaster**************************************************************************************:-");
 //return;
  	String alter=" ALTER TABLE /*IF NOT EXISTS*/  db_gps.t_jettingpumpforcustomfielddata add column  "+expence+" varchar(200) NOT NULL DEFAULT '-' ";
     st1.executeUpdate(alter);
     System.out.println("Alter--------"+alter);

  	String alter1=" ALTER TABLE /*IF NOT EXISTS*/  db_gps.t_jettingpumpforcustomfieldhistory add column  "+expence+" varchar(200) NOT NULL DEFAULT '-' ";
    st11.executeUpdate(alter1);
