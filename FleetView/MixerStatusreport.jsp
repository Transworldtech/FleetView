...
<!-- <div align="left"><font size="3">Report No:1.12</font></div>-->
 <font size="3"><div ><b>Mixer Rotation Report</b></div></font>
...
<th>Duration(HH:mm)</th>
		...
		int i =1,x =0;
		sql1 = "select * from db_gps.t_veh"+VehicleCode+" where Thefielddatadatetime >= '"+fromdate+"' and Thefielddatadatetime <= '"+todate+"' and Thefiledtextfilename in ('MR','MS')  order by Thefielddatadatetime";
		...
		while(rs1.next())
		{
			...
			if(flag == true)
			{
			 ...
			 if(rs1.getString("Thefiledtextfilename") == "MR" || rs1.getString("Thefiledtextfilename").equalsIgnoreCase("MR"))
			 {
				 System.out.println("flag  "+flag);
				 flag=false;
					x=1;
			...
			if(x==1)
			{
				 if(rs1.getString("Thefiledtextfilename") == "MS" || rs1.getString("Thefiledtextfilename").equalsIgnoreCase("MS"))
				 {
