...
<table width="100%" border="1" valign="topo" class="stats">
   		...
   		if (GBrowserIsCompatible()) 
 		{
	        ...
	        var htmls = [];
 	        ...
 	        arrowIcon.infoWindowAnchor = new GPoint(0,0);
 	      	...
 	      	var geoXml = new GGeoXml("http://myfleetview.com/FleetView/ALLbaseKMLFORCASTROLROUTES.kml"); 
...
st=conn.createStatement();
	...
	sql="select WareHouseCode,WareHouse,Owner,Latitude,Longitude from t_warehousedata where Owner like 'Castrol' group by  WareHouseCode,WareHouse,Owner,Latitude,Longitude order by WareHouse";
