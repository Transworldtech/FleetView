...
try
{
	...
	//String Transporter=session.getAttribute("usertypevalue").toString();
	 ...
	 <a href="excel_runhours_8.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Primary&con=10"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
	 ...
	 &nbsp;&nbsp;&nbsp;Date : <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new java.util.Date())%></div>
			...
			<tr><td>
	       <div class="bodyText" align="right">
	    <a href="excel_runhours_8.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Secondary&con=10"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
		...
		<%	}
			      ...
			      else 
			      {
			    	  if(category.equalsIgnoreCase("Tanker"))
						{  %>
			    			...
			    			<tr><td>
			    	       <div class="bodyText" align="right">
			    	    <a href="excel_runhours_8.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Tanker&con=12"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
			    	 ...
			    	 <%  }
			    	    ...
			    	    {  %>
			    			...
			    			<tr><td>
			    	       <div class="bodyText" align="right">
			    	    <a href="excel_runhours_8.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Primary&con=12"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
			    	 ...
			    	 &nbsp;&nbsp;&nbsp;Date : <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new java.util.Date())%></div>
			    	  ...
			    	  <%  }
			    	    else
			    	    {
			    			...
			    			<tr><td>
			    	       <div class="bodyText" align="right">
			    	    <a href="excel_runhours_8.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Secondary&con=12"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
			...
			else if(thename.equals("ended"))
			{
				...
				<tr align="center"><td><b><font size="3">Daily Driving Hrs Violation Report For Tanker :- <%=new SimpleDateFormat("MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(fromdate)) %></font></b></td></tr>
				 <tr><td>
         	 <div class="bodyText" align="right">
	         <a href="excel_runhours_8.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Tanker&con=10"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
