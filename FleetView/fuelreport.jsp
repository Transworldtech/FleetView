...
try{
	...
	<table border="0" width="100%">
		...
		<td bgcolor="#FFFFFF" class="sorttable_nosort"><b><a href="notactive.jsp">Not Active</a></b>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Hide Trip Info" onclick="showhide1();" class="formElement" id="tdx" ></td>
			...
			<th> <b>Speed</b></th>
			<th> <b>OS Today</b></th>
			<th> <b>Km Driven Today</b></th>
			<th> <b>Km Driven This Month</b></th>
			<th> <b>Avg. Today</b></th>
			<th> <b>Avg. This Month</b></th>
			<th> <b>Fuel</b></th>
			...
			while(rst.next())
			{
		   	...
		   	<tr>
				<td> <a href="javascript:toggleDetails(<%=i%>,false);">Close </a>
					...
					<td style="<%=bgcolor %>"><%=fleetview.IgnitionONOFF(rst.getString("VehicleCode")) %></td>
					<td style="<%=bgcolor %>"><div align="right"><%=rst.getInt("TheSpeed") %></div></td>
					<td style="<%=bgcolor %>"><div align="right"><%=fleetview.OSToday(rst.getString("VehicleCode")) %></div></td>
					<td style="<%=bgcolor %>"><div align="right"><%=fleetview.KmTodayVehicle(rst.getString("VehicleCode")) %></div></td>
					<td style="<%=bgcolor %>"><div align="right"><%=fleetview.KmThisMonthVehicle(rst.getString("VehicleCode")) %></div></td>
					...
					<td style="<%=bgcolor %>">-</td>
					<td style="<%=bgcolor %>">-</td>
					<td style="<%=bgcolor %>"><%=fleetview.getFuelLevel(rst.getString("VehicleCode"),i) %></td> 
					<td style="<%=bgcolor %>"><%=fleetview.getFuelAlertToday(rst.getString("VehicleCode")) %></td>
					<%
					}
					else
					{
						%>
						<td style="<%=bgcolor %>">NA</td>
						<td style="<%=bgcolor %>">NA</td>
						<td style="<%=bgcolor %>">NA</td>
						<td style="<%=bgcolor %>">NA</td>
						<%
