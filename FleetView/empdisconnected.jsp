...
function showhide1()
{
	...
	else
	{
		...
		{	
			...
			<div ><font size="3"><b> Device Disconnected Vehicle </b></font></div>
				<div align="right">
				<a href="#" onclick="javascript:window.open('printdisconnected.jsp');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; 
				<a href="exceldisconnected.jsp"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>
				<%=fleetview.PrintDate()%>
				</div>
			</td>
			</tr>
