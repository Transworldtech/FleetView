...
{  
    ...
    document.cameraDetailReport.action ="excel.jsp";
    document.forms["cameraDetailReport"].submit();
} 
...
<!-- <div align="left"><font size="3"><b>Report No:1.1</b></font></div>-->
 ...
 <div align="center"><font size="3"><b> POD Detail Report<b></font></div>
</td>
</tr>
</table>

<form name="customdetail" method="post" action="" Onsubmit="return datevalidate()" >
	 <%String imeino =request.getParameter("imeino");
...
<% 
       //  System.out.println("imeino= "+imeino1);
		...
		<div class="bodyText" align="right">
		    ...
		    <br>
			<form id="cameraDetailReport" name="cameraDetailReport" action="" method="post" >
			...
			<tr><div align="center"><font size="3" color="block" size="2" ><b>Detail  Report  for  <%=imeino %>  From  <%=datenew1%>  To  <%=datenew2%></b></font>
			</div>
			</tr>
			<tr>
			<div align="right">
...
//	  out.print(sdt); 
	%></div>
			...
			<th id="tdp0" align="right" style="width: 3px;"> <b>sr no</b></th>
					...
					<th id="tdp0" style="width: 230px;"> <b> DateTime</b></th>
					...
					double lat=0.0,lon=0.0;
							...
							String sql3="select * from t_veh"+vehcode+"  where TheFieldDataDate between '"+ddate1+"' and '"+ddate2+"' order by TheFieldDataDate,TheFieldDataTime asc";	
							...
							while(rs3.next())
							{
			                       ...
			                       lat=rs3.getDouble("LatinDec");
			                       lon=rs3.getDouble("LonginDec");
			                       filename=rs3.getString("Sen1");
			                       Value1=rs3.getString("Sen2");
								   Value2=rs3.getString("Sen3");
								   Value3=rs3.getString("Sen4");
			             %>
			            <tr>
			            <td><div align="right"><%=j%></div></td>
			            <td><div align="right"><%=imeino%></div></td>
			            <td class="bodyText"><div align="right"><%=new SimpleDateFormat("dd-MMM-yyyy").format(rs3.getDate("TheFieldDataDate"))%>  <%=" "+rs3.getString("TheFieldDataTime")%></div></td>
