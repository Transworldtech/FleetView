...
<tr><td align="left" colspan="2"><!-- <div align="left"><font size="3" >Report No: 10.24</font></div>--></td></tr>
<tr align="center">
<td>
	...
	if(!(null==sortby))
	{
		if(sortby.equals("trans"))
		{
			if(thename.equals("started"))
			{
				...
				%>
				<tr><td><b><font size="2">Castrol Primary Manual Trips Captured For<%=rng%> -By Contractor(Started)</font></b></td></tr>
				 <tr><td>
	 <div class="bodyText" align="right">
	 <a href="excel_primarymanual.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&sortby=<%=sortby%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
	 &nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.open('print_primarymanual.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&sortby=<%=sortby%>');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>
	 &nbsp;&nbsp;&nbsp;Date : <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new java.util.Date())%></div>
			...
			{
				%>
				<tr><td><b><font size="2">Castrol Primary Manual Trips Captured For<%=rng%> -By Contractor(Ended)</font></b></td></tr>
				 <tr><td>
	 <div class="bodyText" align="right">
	 <a href="excel_primarymanual.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&sortby=<%=sortby%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
	 &nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.open('print_primarymanual.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&sortby=<%=sortby%>');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>
	 &nbsp;&nbsp;&nbsp;Date : <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new java.util.Date())%></div>
			...
			{
				%>
				<tr><td><b><font size="2">Castrol Primary Manual Trips Captured For<%=rng%> -By Contractor(Started And Ended )</font></b></td></tr>
				 <tr><td>
	 <div class="bodyText" align="right">
	 <a href="excel_primarymanual.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&sortby=<%=sortby%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
	 &nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.open('print_primarymanual.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&sortby=<%=sortby%>');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>
	 &nbsp;&nbsp;&nbsp;Date : <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new java.util.Date())%></div>
		...
		else if(sortby.equals("location"))
		{
			...
			{
				%>
				<tr><td><b><font size="2">Castrol Primary Manual Trips Captured For<%=rng%> -By Location(Started)</font></b></td></tr>
				 <tr><td>
	 <div class="bodyText" align="right">
	 <a href="excel_primarymanual.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&sortby=<%=sortby%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
	 &nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.open('print_primarymanual.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&sortby=<%=sortby%>');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>
	 &nbsp;&nbsp;&nbsp;Date : <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new java.util.Date())%></div>
			...
			{
				%>
				<tr><td><b><font size="2">Castrol Primary Manual Trips Captured For<%=rng%> -By Location(Ended)</font></b></td></tr>
				 <tr><td>
	 <div class="bodyText" align="right">
	 <a href="excel_primarymanual.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&sortby=<%=sortby%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
	 &nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.open('print_primarymanual.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&sortby=<%=sortby%>');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>
	 &nbsp;&nbsp;&nbsp;Date : <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new java.util.Date())%></div>
			...
			{
				%>
				<tr><td><b><font size="2">Castrol Primary Manual Trips Captured For<%=rng%> -By Location(Started And Ended)</font></b></td></tr>
				 <tr><td>
	 <div class="bodyText" align="right">
	 <a href="excel_primarymanual.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&sortby=<%=sortby%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
	 &nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.open('print_primarymanual.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&sortby=<%=sortby%>');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>
	 &nbsp;&nbsp;&nbsp;Date : <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new java.util.Date())%></div>
		...
		else 
		{
			...
			{
				%>
				<tr><td><b><font size="2">Primary Manual Trips Captured For<%=rng%> -By Location(Started)</font></b></td></tr>
				 <tr><td>
	 <div class="bodyText" align="right">
	 <a href="excel_primarymanual.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&sortby=<%=sortby%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
	 &nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.open('print_primarymanual.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&sortby=<%=sortby%>');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>
				...
				//	System.out.println(sqll1);
					...
					while(rstt1.next())
					{
						...
						vehcountall=vehcountall+rstt1.getInt("Vehid");
								...
								String zsqlr="select Transporter,count(TripID) as Trip from t_CastrolTripsEnded where TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and KmTraveled='0' and Category='Primary'   and EndedBy<>'-' and tripenddate<>'NA'  and StartPlace='"+startplace+"'";
							//	System.out.println("kiran"+zsqlr);
								...
								String zsqle="select count(TripID) as Trip from t_CastrolTripsEnded where TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59'   and OSCount='0' and RACount='0' and RDCount='0' and KmTraveled<>'0' and Category='Primary'   and EndedBy<>'-' and tripenddate<>'NA'     and StartPlace='"+startplace+"'";
								...
								String zsqlg="select count(TripID) as Trip from t_CastrolTripsEnded where TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59'    and (OSCount>'0' or RACount>'0' or RDCount>'0') and KmTraveled<>'0'  and Category='Primary'   and EndedBy<>'-' and tripenddate<>'NA'    and StartPlace='"+startplace+"'";
								//System.out.println("kiran"+zsqle);
					...
					<tr>
					<td><%=k%></td>
					<td><div align="left"><a href="#" onclick="javascript:window.open('LocationwisePrimaryManual.jsp.jsp?startplace=<%=startplace.replace("&","and")%>&date1=<%=fromdate %>&date2=<%=todate %>&triptype=<%=thename%>');"><%=startplace%></a>
					</div></td>
				...
				<td  class="hed"> Rating</td>
					...
					while(rstt.next())
					{
						...
						vehcountall=vehcountall+rstt.getInt("Vehid");
								...
								String zsqlrg1="select Transporter,count(TripID) as Trip from t_CastrolTripsEnded where TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59'   and(OSCount>'0' or RACount>'0' or RDCount>'0') and KmTraveled<>'0'   and Category='primary'   and EndedBy<>'-' and tripenddate<>'NA'   and Transporter='"+startplace+"'";
								//System.out.println(sqll);
								...
								String zsqlz="select count(TripID) as Trip from t_CastrolTripsEnded where TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59'    and OSCount='0' and RACount='0' and RDCount='0' and KmTraveled<>'0'  and Category='primary'   and EndedBy<>'-' and tripenddate<>'NA'    and Transporter='"+startplace+"'";
							...
							//	     System.out.println("zcount=================================>"+zcount);
								...
								String zsqlrr="select Transporter,count(TripID) as Trip from t_CastrolTripsEnded where TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and KmTraveled='0'  and Category='primary'   and EndedBy<>'-' and tripenddate<>'NA'  and Transporter='"+startplace+"'";
					...
					<tr>
					<td><%=k%></td>
					<td><div align="left"><a href="#" onclick="javascript:window.open('driverwisePrimaryManual.jsp?startplace=<%=startplace.replace("&","and")%>&date1=<%=fromdate %>&date2=<%=todate %>&triptype=<%=thename%>');"><%=startplace%></a>
					</div></td>
				...
				//	System.out.println(sqll);
					...
					while(rstt.next())
					{
						...
						vehcountall=vehcountall+rstt.getInt("Vehid");
								...
								String zsqlg="select count(TripID) as Trip from t_CastrolTripsStarted  where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59'    and (OSCount>'0' or RACount>'0' or RDCount>'0') and KmTraveled<>'0' and  Category='primary'   and EndedBy<>'-' and tripenddate<>'NA'     and StartPlace='"+startplace+"'";
							   ...
							   String zsqlr="select Transporter,count(TripID) as Trip from t_CastrolTripsStarted  where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and KmTraveled='0' and  Category='primary'   and EndedBy<>'-' and tripenddate<>'NA'  and StartPlace='"+startplace+"'";
								...
								String zsqlv="select Transporter,count(TripID) as Trip from t_CastrolTripsStarted where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59'    and OSCount='0' and RACount='0' and RDCount='0' and KmTraveled<>'0' and  Category='primary'   and EndedBy<>'-' and tripenddate<>'NA' and StartPlace='"+startplace+"'";
					...
					<tr>
					<td><%=k%></td>
					<td><div align="left"><a href="#" onclick="javascript:window.open('LocationwisePrimaryManual.jsp?startplace=<%=startplace.replace("&","and")%>&date1=<%=fromdate %>&date2=<%=todate %>&triptype=<%=thename%>');"><%=startplace%></a>
					</div></td>
				...
				//	System.out.println(sqll);
					...
					while(rstt.next())
					{
						...
						vehcountall=vehcountall+rstt.getInt("Vehid");
								...
								String zsqlg3="select Transporter,count(TripID) as Trip from t_CastrolTripsStarted where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59'   and(OSCount>'0' or RACount>'0' or RDCount>'0') and KmTraveled<>'0' and Category='primary'   and EndedBy<>'-' and tripenddate<>'NA'   and Transporter='"+startplace+"'";
								...
								String zsqlr3="select Transporter,count(TripID) as Trip from t_CastrolTripsStarted where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and KmTraveled='0' and Category='primary'   and EndedBy<>'-' and tripenddate<>'NA'  and Transporter='"+startplace+"'";
								...
								String zsql1="select count(TripID) as Trip from t_CastrolTripsStarted where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59'    and OSCount='0' and RACount='0' and RDCount='0' and KmTraveled<>'0' and Category='primary'   and EndedBy<>'-' and tripenddate<>'NA'    and Transporter='"+startplace+"'";
									//System.out.println(sqll);
	...
	else if(thename.equalsIgnoreCase("both"))
	{
			...
			//	System.out.println(sqll);
				...
				while(rstt.next())
				{
					...
					vehcountall=vehcountall+rstt.getInt("Vehid");
							...
							String	zsqlg3="select Transporter,count(TripID) as Trip2 from t_CastrolTripsStartEnded where TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59'    and(OSCount>'0' or RACount>'0' or RDCount>'0') and KmTraveled<>'0'   and Category='primary'   and EndedBy<>'-' and tripenddate<>'NA'  and StartPlace='"+startplace+"'";
							//System.out.println(sqll);
							...
							if(zrstg3.next())
							{
							 ...
							 String	zsqlr3="select Transporter,count(TripID) as Trip2 from t_CastrolTripsStartEnded where TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59'     and KmTraveled='0'  and Category='primary'   and EndedBy<>'-' and tripenddate<>'NA' and StartPlace='"+startplace+"'";
								//System.out.println(sqll);
						 ...
						 String	zsql3="select Transporter,count(TripID) as Trip2 from t_CastrolTripsStartEnded where TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59'    and OSCount='0' and RACount='0' and RDCount='0' and KmTraveled<>'0'  and Category='primary'   and EndedBy<>'-' and tripenddate<>'NA' and StartPlace='"+startplace+"'";
							//System.out.println(sqll);
...

		{
					...
					<td  class="hed"> Rating</td>
						...
						kmcountall=0;tripcountall=0;drivercountall=0;ratingcountall=0.0;vehcountall=0;oscountall=0;racountall=0;
						rdcountall=0;cdcountall=0;ndcountall=0;	countlatency=0;	durationall=0;int j=0;kmcount=0;tripcount=0;
						totpbrief=0;totpdebrief=0;zcountall=0;zcount=0;zcountr=0;zcountrall=0;zcountg=0;zcountgall=0;
						int tbcount=0;
						int tdbcount=0;
						//sqll="select Distinct(StartCode) from t_completedjourney where EndDate>= '"+fromdate+"' and EndDate <='"+todate+"' and GPName='Castrol' order by StartPlace Asc";
						sqll="select Transporter,count(TripID) as TripID,count(Distinct(DriverID)) as DriverID,count(Distinct(Vehid)) as Vehid,sum(KmTraveled) as KmTraveled,sum(OSCount) as OSCount,sum(OSDusration) as OSDuration,sum(RACount) as RACount,sum(RDCount) as RDCount  from t_CastrolTripsStartEnded where TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59' and Category='primary'   and EndedBy<>'-' and tripenddate<>'NA' group by Transporter order by Transporter Asc";
					//	System.out.println(sqll);
						...
						while(rstt.next())
						{
							...
							vehcountall=vehcountall+rstt.getInt("Vehid");
									...
									String	zsqlg="select Transporter,count(TripID) as Trip2 from t_CastrolTripsStartEnded where TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59'    and(OSCount>'0' or RACount>'0' or RDCount>'0') and KmTraveled<>'0' and Category='primary'  and EndedBy<>'-' and tripenddate<>'NA'  and Transporter='"+startplace+"'";
									//System.out.println(sqll);
									...
									if(zrstg.next())
									{
									 ...
									 String	zsqlr="select Transporter,count(TripID) as Trip2 from t_CastrolTripsStartEnded where TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59'   and Category='primary'  and EndedBy<>'-' and tripenddate<>'NA'   and KmTraveled='0'and Transporter='"+startplace+"'";
										//System.out.println(sqll);
								 ...
								 String	zsql2="select Transporter,count(TripID) as Trip2 from t_CastrolTripsStartEnded where TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59'    and OSCount='0' and RACount='0' and RDCount='0' and KmTraveled<>'0' and Category='primary'  and EndedBy<>'-' and tripenddate<>'NA'  and Transporter='"+startplace+"'";
									//System.out.println(sqll);
