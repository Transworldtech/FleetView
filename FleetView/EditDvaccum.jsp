...
<%	
String exportFileName="VacuumReport.xls";
String name="",bb="",cc="";
...
%>
	...
	<form id="Total_os" name="Total_os" action="" method="post">
		...
		<h1 align="center"><font size="3" >Vacuum Pump Custom Field Details <%=VehRegNo %></font></h1>
		<br>
...
<a href="Dvaccum.jsp?VehId=<%=VehId%>&VehRegNo=<%=VehRegNo%>"><font bgcolour="blue" size="2">Add Custom Field</font></a><br>
<a href="Daddvaccum.jsp?VehId=<%=VehId%>&VehRegNo=<%=VehRegNo%>"><font face="Arial" size="2">Fill Information</font></a>
</h2>
	 ...
	 int Countforfield=0;
	  ...
	  rst = st4.executeQuery("Select * from  db_gps.t_vaccumsystemforcustomfieldmaster where Owner='"+transporter+"'  ");
	 while(rst.next())
	 {
	...
	if(Countforfield==0)
	{
	 ...
	 %>
 	 ...
 	 int Count1=1;
 	  rst3 = st3.executeQuery("Select * from  db_gps.t_vaccumsystemforcustomfieldmaster where Owner='"+transporter+"'");
 	 while(rst3.next())
 	 { 
...
if(Countforfield==0)
{
	...
	rst1=st5.executeQuery("Select id,"+FieldName+" from  db_gps.t_vaccumsystemforcustomfielddata  where VehId='"+VehId+"' and Owner='"+transporter+"'");
...
<a href="Deletevaccum.jsp?id=<%=abwc%>&VehId=<%=VehId%>&VehRegNo=<%=VehRegNo%>"><font color="Blue" size="2">Delete</font></a>
  	</div>
  	</td>
