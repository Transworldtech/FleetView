...
if (browser.isIE5x)
	...
	addmenu(menu=["Vendor",				//ITEM2
		...
		,"Daily Report Of OverDue Books","listofoverdueNotReturnedbooks.jsp",,,
		,"Reports for Book/CD/Periodicals","reportsforbookcdperiodicals.jsp",,,
		,"Daily Report Of Books","DailyReportOfTransaction.jsp",,,
		])
...
if (screen.width == 1024)
{
	if (browser.isIE5x)
	{
		...
		109,					// Menu Top - The Top position of the menu in pixels
		3,					// Menu Left - The Left position of the menu in pixels
		109,					// Menu Width - Menus width in pixels
		0,					// Menu Border Width 
		,					// Screen Position - here you can use "center;left;right;middle;top;bottom" or a combination of "center:middle"
		style1,				// Properties Array - this is set higher up, as above
		1,					// Always Visible - allows the menu item to be visible at all time (1=on/0=off)
	...
	else
	{
		...
		109,					// Menu Top - The Top position of the menu in pixels
		3,					// Menu Left - The Left position of the menu in pixels
		101,					// Menu Width - Menus width in pixels
		0,					// Menu Border Width 
		,					// Screen Position - here you can use "center;left;right;middle;top;bottom" or a combination of "center:middle"
		style1,				// Properties Array - this is set higher up, as above
		1,					// Always Visible - allows the menu item to be visible at all time (1=on/0=off)
