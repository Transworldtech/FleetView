...
try{	
		...
		compareDate=rsCompareDate.getInt(1);
			...
			<!-- <tr><td align="left"><div align="left"><font size="3" >Report No: 10.20</font></div></td></tr>-->
			<tr><td>
			<font size="3"><b><center>Report for ND Secondary Trips from <%=data1%> to <%=data2%></center></b></font>
<div align="right">
				<a href="#" onclick="javascript:window.open('print_NDSecondary.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&triptype=<%=triptype%>');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; 
				<a href="excel_NDSecondary.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&triptype=<%=triptype%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>
		...
		if(triptype.equalsIgnoreCase("started"))
		{
			String sqll="";
			if(compareDate>0)
				sqll="select count(TripID) as TripID,count(Distinct(DriverID)) as DriverID,"+
				" count(Distinct(Vehid)) as Vehid,sum(KmTraveled) as KmTraveled,sum(OSCount) as OSCount,"+
				" sum(OSDusration) as OSDuration,sum(RACount) as RACount,sum(RDCount) as "+
				" RDCount,sum(ND) as NDCount  from t_CastrolTripsStarted where TripStartDate "+
				" between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='Secondary'  and ND>0";
		   else		
			   sqll="select count(TripID) as TripID,count(Distinct(DriverID)) as DriverID,count(Distinct(Vehid)) as Vehid,sum(KmTraveled) as KmTraveled,sum(OSCount) as OSCount,sum(OSDusration) as OSDuration,sum(RACount) as RACount,sum(RDCount) as RDCount,sum(ND) as NDCount  from t_CastrolTripsStarted where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='Secondary' and status<>'Faulty' and ND='Yes'";
		...
		while(rstt.next())
		{
			...
			vehcountall=rstt.getInt("Vehid");
					...
					String sql11="Select count(CD) as cdcount1 from t_CastrolTripsStarted where CD='Yes' and TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='Secondary' and status<>'Faulty' and ND='Yes'";
					...
					/*String sql12="Select count(ND) as ndcount1 from t_CastrolTripsEnded where ND='Yes' and TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='Secondary' and status<>'Faulty'";
					...
					String sql13="Select count(Briefing) as bcount1 from t_CastrolTripsStarted where Briefing='briefed' and TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='Secondary' and status<>'Faulty' and ND='Yes'";
					...
					String sql14="Select count(Debriefing) as dbcount1 from t_CastrolTripsStarted where Debriefing='Yes' and TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='Secondary' and status<>'Faulty' and ND='Yes'";
					...
					String sqlall="";
					if(compareDate>0)
					  sqlall="Select * from t_CastrolTripsStarted where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='Secondary'   and ND>0";
				  else
					  sqlall="Select * from t_CastrolTripsStarted where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='Secondary' and status<>'Faulty' and ND='Yes'";
					out.print(sqlall);
...
<!--				</td></tr>-->
		...
		<%
					...
					<td class="hed"><div align="right"><%=ndcountall1%></div></td>
		...
		else if(triptype.equalsIgnoreCase("ended"))
		{
			...
			while(rstt.next())
			{
				...
				vehcountall=rstt.getInt("Vehid");
						...
						String sql11="Select count(CD) as cdcount1 from t_CastrolTripsEnded where CD='Yes' and TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='Secondary' and status<>'Faulty' and ND='Yes'";
						ResultSet rstcd=st.executeQuery(sql11);
						if(rstcd.next())
						{
							//cdcount=rstcd.getInt("cdcount1");
						...
						String sql13="Select count(Briefing) as bcount1 from t_CastrolTripsEnded where Briefing='briefed' and TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='Secondary' and status<>'Faulty' and ND='Yes'";
						ResultSet rstb=st.executeQuery(sql13);
						if(rstb.next())
						{
							//bcount=rstb.getInt("bcount1");
						...
						String sql14="Select count(Debriefing) as dbcount1 from t_CastrolTripsEnded where Debriefing='Yes' and TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='Secondary' and status<>'Faulty' and ND='Yes'";
						ResultSet rstdb=st.executeQuery(sql14);
						if(rstdb.next())
						{
							//dbcount=rstdb.getInt("dbcount1");
						...
						String sqlall="Select * from t_CastrolTripsEnded where TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='Secondary' and status<>'Faulty' and ND='Yes'";
						ResultSet rstall=st1.executeQuery(sqlall);
						while(rstall.next())
						{
...
<!--					</td></tr>-->
		...
		else
		{
			...
			//sqll="select Distinct(StartCode) from t_completedjourney where EndDate>= '"+fromdate+"' and EndDate <='"+todate+"' and GPName='Castrol' order by StartPlace Asc";
			String sqll="select count(TripID) as TripID,count(Distinct(DriverID)) as DriverID,count(Distinct(Vehid)) as Vehid,sum(KmTraveled) as KmTraveled,sum(OSCount) as OSCount,sum(OSDusration) as OSDuration,sum(RACount) as RACount,sum(RDCount) as RDCount,sum(ND) as NDCount  from t_CastrolTripsStartEnded where TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59' and Category='Secondary' and status<>'Faulty' and ND='Yes'";
			//System.out.println(sqll);
			ResultSet rstt=stt.executeQuery(sqll);
			while(rstt.next())
			{
				...
				vehcountall=rstt.getInt("Vehid");
						...
						String sql11="Select count(CD) as cdcount1 from t_CastrolTripsStartEnded where CD='Yes' and TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59' and Category='Secondary' and status<>'Faulty' and ND='Yes'";
						ResultSet rstcd=st.executeQuery(sql11);
						if(rstcd.next())
						{
							//cdcount=rstcd.getInt("cdcount1");
						...
						String sql13="Select count(Briefing) as bcount1 from t_CastrolTripsStartEnded where Briefing='briefed' and TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59' and Category='Secondary' and status<>'Faulty' and ND='Yes'";
						ResultSet rstb=st.executeQuery(sql13);
						if(rstb.next())
						{
							//bcount=rstb.getInt("bcount1");
						...
						String sqlall="Select * from t_CastrolTripsStartEnded where TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59' and Category='Secondary' and status<>'Faulty' and ND='Yes'";
						ResultSet rstall=st1.executeQuery(sqlall);
						while(rstall.next())
						{
