...
<%!
  ...
  <% 
	...
	String str= "select * from t_veh"+vehiclecode+ " where TheFieldDataDate>='"+date1+ "' and TheFieldDataDate <='"+ date2 +"' and TheFiledTextFileName in ('OF','ON','SI') order by TheFieldDataDate asc";
...
%>
<table class="stats">
<tr><th colspan="12">Disconnected Report for <%=user%> transporter from date <%=data1%> to <%=data2%>. <div align="right">
</div></th></tr>
<tr>		
