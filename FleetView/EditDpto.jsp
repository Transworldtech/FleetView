...
<%	
String exportFileName="PtoReport.xls";
String name="",bb="",cc="";
...
<form id="Total_os" name="Total_os" action="" method="post">
		...
		<h1 align="center"><font size="3" ><b>PTO Custom Field Details <%=VehRegNo %></b></font></h1>
		<br>
		

<h2 align="center">

<a href="Dpto.jsp?VehId=<%=VehId%>&VehRegNo=<%=VehRegNo%>"><font bgcolour="blue" size="2">Add Custom Field</font></a><br>
<a href="Daddpto.jsp?VehId=<%=VehId%>&VehRegNo=<%=VehRegNo%>"><font face="Arial" size="2">Fill Information</font></a>
	 ...
	 int Countforfield=0;
	  ...
	  rst = st4.executeQuery("Select * from db_gps.t_custpto where Owner='"+transporter+"' ");
	 while(rst.next())
	 {
...
// 	 System.out.println("FieldName:-"+FieldName); 
	...
	System.out.println("FieldName:-"+FieldName);
	 ...
	 %>
 	 ...
 	 int Count1=1;
 	  rst3 = st3.executeQuery("Select * from db_gps.t_custpto where Owner='"+transporter+"'");
 	 while(rst3.next())
 	 { 
...
if(Countforfield==0)
{
	...
	rst1=st5.executeQuery("Select id,"+FieldName+" from db_gps.t_custompto where VehId='"+VehId+"' and  Owner='"+transporter+"' ");
...
while(rst1.next())
{
	...
	%>
 	...
 	%> 
  	<div align="center"><a href="Deletepto.jsp?id=<%=abwc%>&VehId=<%=VehId%>&VehRegNo=<%=VehRegNo%>"><font color="Blue" size="2">Delete</font></a></div>
   <% 
