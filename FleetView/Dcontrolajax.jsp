...
<%!
Connection con1;
Statement st,st1,st2,st3,st4,st5,st18,st13;
ResultSet rst1=null;
int cnt=0,cnt1=0;
...
String abc="select field from db_gps.t_controlsystemforcustomfieldmaster where field='"+expence+"' and Owner='"+transporter+"' ";
...
if(rst2.next( ))
{
  ...
  String insrtmaster="insert into db_gps.t_controlsystemforcustomfieldmaster(Entryby,Owner,field) values('"+user+"','"+transporter+"','"+expence+"') ";
  cnt=st1.executeUpdate(insrtmaster);
  //out.println("on ajax page insrtmaster"+insrtmaster);
  String insrtmaster1="insert into db_gps.t_controlsystemforcustomfieldmasterhistory(Entryby,Owner,field) values('"+user+"','"+transporter+"','"+expence+"') ";
  cnt=st18.executeUpdate(insrtmaster1);
...
//System.out.println("fulmaster**************************************************************************************:-");
 //return;
 System.out.println("DSCASV------------------------->"+expence);
  	String alter=" ALTER TABLE /*IF NOT EXISTS*/  db_gps.t_controlsystemforcustomfielddata add column  "+expence+" varchar(200) NOT NULL DEFAULT '-' ";
     st1.executeUpdate(alter);
     //out.println("Alter--------"+alter);

     
     String alter1=" ALTER TABLE /*IF NOT EXISTS*/  db_gps.t_controlsystemforcustomfieldhistory add column  "+expence+" varchar(200) NOT NULL DEFAULT '-' ";
     st13.executeUpdate(alter1);
     //out.println("Alter--------"+alter1);
