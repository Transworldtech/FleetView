...
<%
	...
	String discription="-";
String datetime="-";
	if (request.getParameter("Vehcode") !=null) {
vehcode1 =request.getParameter("Vehcode");
vehcode1.replaceAll(" ","");
}

	//String Muser = request.getParameter("user");
	Connection con = DriverManager.getConnection("jdbc:mysql://localhost/db_gps","fleetview","1@flv");
	Statement s = con.createStatement();
	
String sql3 = "SELECT VehicleCode,VehicleRegNo,TheDate,TheTime,Location,Transporter,LatitudePosition,LatitudePosition+0.001 as lat1,LongitudePosition,LongitudePosition+0.001 as lon1  FROM t_onlinedata where replace(VehicleRegNo,' ','') ='"+vehcode1+"'" ;
	...
	datetime=new SimpleDateFormat("dd-MM-yyyy").format(thedate);

	discription=vehregno+"<br>"+datetime+" "+thetime+"<br>"+location; 
	}
%>
