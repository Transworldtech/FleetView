...
<% 
	...
	String filename=session.getAttribute("user").toString()+showdatex+"CastrolBriefing_Report.xls";
...
try{
	...
	<table border="0" width="100%">
			...
			<tr><td>
			<font size="3"><b><center>Report for Briefing for <%=data1%> </center></b></font>
		...
		while(rstt.next())
		{
			...
			vehcountall=rstt.getInt("Vehid");
					...
					String sqlall="Select * from t_CastrolTripsStarted where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Briefing='briefed' and status<>'Faulty'";
