...
String transporter=session.getAttribute("usertypevalue").toString();
    ...
    //out.println("expence after:-"+expence);
...
try{
	...
	//String LTRIM(RTRIM(strstr)))=vvv.replace("---"," ");
	//System.out.println("STRSTR:-"+expence);
	
String abc="select field from db_gps.t_custpto where field='"+expence+"' ";
...
if(rst2.next( ))
{
  ...
  String insrtmaster="insert into db_gps.t_custpto(Entryby,Owner,field) values('"+user+"','"+transporter+"','"+expence+"') ";
  cnt=st1.executeUpdate(insrtmaster);
  
  String insrtmaster1="insert into db_gps.t_custptohistory(Entryby,Owner,field) values('"+user+"','"+transporter+"','"+expence+"') ";
  st5.executeUpdate(insrtmaster1);
...
//System.out.println("fulmaster**************************************************************************************:-");
 //return;
  	String alter=" ALTER TABLE /*IF NOT EXISTS*/  db_gps.t_custompto add column  "+expence+" varchar(200) NOT NULL DEFAULT '-' ";
     st1.executeUpdate(alter);
     System.out.println("Alter--------"+alter);
     //out.println("ALTERRRRRRRR----"+alter);

   	String alter1=" ALTER TABLE /*IF NOT EXISTS*/  db_gps.t_customptohistory add column  "+expence+" varchar(200) NOT NULL DEFAULT '-' ";
