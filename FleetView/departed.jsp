...
%>
			...
			<tr>
			<td align="center">
			<!-- <div align="left"><font size="3" >Report No: 3.3</font></div>-->
			<font  size="3" ><b>Vehicle Departed Report</b></font></td>
			</tr>
			<tr><td>
	...
	{
		sql="select * from t_completedjourney where StartCode in "+locationlist+" and GPName='"+mainuser+"'  and StartDate >='"+thedate+"'  and StartDate <='"+edate+"' order by StartDate asc";
	}
	//out.print(sql);
	ResultSet rst=st.executeQuery(sql);
	%>
	<table border="0" width="100%" class="stats" >
	<tr><td align="center"><font size="3"><b>
	Vehicle Departed
	<%
	...
	{
		out.print(" from "+session.getAttribute("Location").toString() +" From "+new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(thedate))+" to "+new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(edate)) );
	}
	%>
	<div align="right">
				<a href="#" onclick="javascript:window.open('printdeparted.jsp?data=<%=thedate %>&data1=<%=edate %>');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; 
				<a href="exceldeparted.jsp?data=<%=thedate %>&data1=<%=edate %>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>
