...
<table border="0" width="100%" align="center" class="stats">
			<tr><td>
			<font size="2"><b>All JDData Trips From <%=datenew1%> to <%=datenew2%></b></font>
			</td>
			</tr>
			</table>
	...
	{
		sql="Select TripID,VehRegNo,StartPlace,EndPlace,StartDate,DriverName,DriverCode,OwnerName,Category from t_alljddata where StartDate BETWEEN '"+fromdate+"' and '"+todate+"' group by TripId order by StartDate Asc";
