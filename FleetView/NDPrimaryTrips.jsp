...
try{
	...
	compareDate=rsCompareDate.getInt(1);
			...
			<tr><td>
			<font size="3"><b><center>Report for ND Primary Trips from <%=data1%> to <%=data2%></center></b></font>
<div align="right">
				<a href="#" onclick="javascript:window.open('print_NDPrimary.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&triptype=<%=triptype%>');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; 
				<a href="excel_NDPrimary.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&triptype=<%=triptype%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>
		...
		if(triptype.equalsIgnoreCase("started"))
		{
			...
			if(compareDate>0)
				...
				" between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='Primary'  and ND>0";
		   else
		...
		while(rstt.next())
		{
			...
			vehcountall=rstt.getInt("Vehid");
					...
					String sqlall="";
					if(compareDate>0)
						sqlall="Select * from t_CastrolTripsStarted where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='Primary'   and ND>0";
					else
						sqlall="Select * from t_CastrolTripsStarted where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and Category='Primary' and status<>'Faulty' and ND='Yes'";
