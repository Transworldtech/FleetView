...
<form name="CountOfRecordsForm">
		<input type="hidden" name= "cnt" id="cnt" value=<%=numRecords%>></input>
			...
			<!--<div align="right">
				<a href="#" onclick="javascript:window.open('printmissing.jsp');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; 
				<a href="excelmissing.jsp"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>
				<%//=Utilities.printDate() %>
				</div>-->
			
				<div align="right">
				<a href="#" onclick="javascript:window.open('GenericPrint.jsp?&sessiondata=VehiclePositionsViewData&key=DeviceMissing&condition=missing');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; 
				<a href="GenericExportExcel.jsp?&sessiondata=VehiclePositionsViewData&key=DeviceMissing&condition=missing"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>
				<%=Utilities.printDate() %>
				</div>
			</td>
			</tr>
...
<%
			try {
					...
					if(currentRecord.getDeviceStatus().equalsIgnoreCase("Device Missing"))
					{
%>
					<tr>
						<td style="background-color:#D4C0F0;"><%=i%></td>	
						<td style="background-color:#D4C0F0;"><%=currentRecord.getVehicleRegistrationNo()%></td>	
						<td style="background-color:#D4C0F0;"><%=currentRecord.getLastUpdatedDateTime() %></td>
						<td style="background-color:#D4C0F0;"><%=currentRecord.getInstalledPlace()%></td>	
<%
					}
					}
			}
