...
{  
          ...
          document.last7days.action ="excel.jsp";
          document.forms["last7days"].submit();
 }  
</script>
...
%>
<form id="last7days" name="last7days" action="" method="post"
	autocomplete="off">
<div id="mytable">
<body>
	...
	<tr>
		...
		<table border="0" width="100%" class="stats">
			<tr>
				...
				<font size="3"><b>Last 7 Days Exception Report For Full
				Fleet</b></font></td>
			</tr>
			<tr>
				<td colspan="25" align="center"><font size="3"><b>Exception
				Report For <%=usertypevalue %> For the Period : <%
...
%> 23:59:00 PM</b></font>
				<div class="bodyText" align="right"><input type="hidden" id="tableHTML"
					...
					style="border-style: none"></img> </a><%=fleetview.PrintDate() %></div>
				</td>
			</tr>
		...
		<table border="1" width="100%" bgcolor="#F5F5F5" class="sortable">
			<tr align="center">
				<th colspan="25" class="sorttable_nosort">
				<div>Parameters considered for the Report</div>
				</th>
			</tr>
			<tr>
				<td class="bodyText">
		...
		<br>
		<b><font color="blue">Note:'Yes' in Average Speed Considered Column indicates Average
		speed is considered in calculation of Run hrs </font></b> </br>
		<p></p>
		<table border="1" width="100%" class="sortable">
			<tr>
				...
				<th>DayStop(Hrs)</th>
				<th>Disconnection</th>
				<th>Total Disconnection Km</th>
				<th>Average speed Considered</th>
