...
try{		
	...
	/*
Logic was changed in Nov 2011. according to new logic, data should be displayed for all trips instead of only NonFaulty Trips
	*/
			%>
			<table border="0" width="100%">
			<!-- <tr><td align="left"><div align="left"><font size="3" >Report No: 10.13</font></div></td></tr>-->
			<tr><td>
			<font size="3"><b><center>Report for ND Total Trips from <%=data1%> to <%=data2%></center></b></font>
<div align="right">
				<a href="#" onclick="javascript:window.open('print_NDTotalTrips.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&triptype=<%=triptype%>');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; 
				<a href="excel_NDTotalTrips.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&triptype=<%=triptype%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>
		...
		if(compareDate>0)
			...
			" between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59'  and ND>0";
			else
		...
		while(rstt.next())
		{
			...
			vehcountall=rstt.getInt("Vehid");
					...
					String sqlall="";
					if(compareDate>0)
						sqlall="Select * from t_CastrolTripsStarted where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and ND>0";
					else
						sqlall="Select * from t_CastrolTripsStarted where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and status<>'Faulty' and ND='Yes'";
