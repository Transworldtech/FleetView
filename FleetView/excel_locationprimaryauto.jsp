...
<% 
	...
	String filename=session.getAttribute("user").toString()+showdatex+"LocPrimaryAuto_Report.xls";
...
try{
	if(!(null==request.getQueryString()))
	{
		...
		%>
		<font size="3"><b>Auto Trips Report for <%=startplace%> from <%=data%> to <%=data1%></b></font>
