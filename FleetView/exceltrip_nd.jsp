...
String filename=session.getAttribute("user").toString()+showdatex+"trip_nd.xls";
...
%>
<table class="stats">
<tr><th>Night Driving Report for Driver <%=drivername+"("+drivercode+")"%> ,TripID :<%=tripid%> <div align="right" >
Date : <%
