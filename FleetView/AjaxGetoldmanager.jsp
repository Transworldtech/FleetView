...
//	con1 = DriverManager.getConnection(MM_dbConn_STRING,MM_dbConn_USERNAME,MM_dbConn_PASSWORD);
	...
	//sql="select UserName,Email from db_gps.t_userdetails where Transporter like '%"+usertypevalue+"%' and UserName like '%"+oldmanagername+"%' order by UserName asc";
	   ...
	   while(rs2.next())
   	   {
		   ...
		   buffer+="<tr><td><a href='#' onClick='setname1(\""+newmanager+"\")'  style='color: black;'>"+Name+" "+newmanager.replaceAll("(?i)"+oldmanagername,"<font color=blue><u>"+oldmanagername.toUpperCase()+"</u></font>")+".</a></td></tr></td>";
	  }
	 }%>
   <%  
   buffer +="</table></div>";
