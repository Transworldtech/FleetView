...
function showexpence(field){
	...
	//alert(queryString);
	ajaxRequest.open("POST", "DHydrolicajax.jsp" + queryString, true);
...
//			  	alert("in delete function");
			 	if(agree)
			     {
			            ...
			            // alert("before delete");
			            window.location="DHydrolicdelete.jsp?&rid="+id;
...
<br>
<br>
<div align="center" class="headerlay"><table style="color:#fff;"><tbody><tr><td><label id="element_1" name="element_1"  class="description" for="element_1"><font size="3" color="black"><b>Add Custom Field For Hydraulic System</b></font> </label></td></tr></tbody></table></div>
...
<a href="EditDHydrolic.jsp?VehId=<%=VehId%>&VehRegNo=<%=VehRegNo%>"><font color="Blue" size="2">Go Back</font></a>
</div>
...
<!-- <td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Length : </b> </label><input id="element_3_4" name="element_3_4"  class="element text medium" type="text"  value=""/><br><label id="element_error_3"></label><br><br>2,2</td> -->
						...
						<% int j=1;
    String Sqlday="select * from db_gps.t_hydrolicsystemforcustomfieldmaster where Owner='"+transporter+"' ";
