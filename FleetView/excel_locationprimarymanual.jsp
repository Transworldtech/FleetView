...
<% 
	...
	String filename=session.getAttribute("user").toString()+showdatex+"LocPrimaryManual_Report.xls";
...
try{
	if(!(null==request.getQueryString()))
	{
		...
		%>
		<font size="3"><b>Manual Trips Report for <%=startplace%> from <%=data%> to <%=data1%></b></font>
		...
		<table border="1" width="100%" class="sortable">
					...
					String tripcount="-";
					String drivercount="-";
					String cdcount="-",stdkm1="",ttime1="",endedby="";
					String ndcount="-";
