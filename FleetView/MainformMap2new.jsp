...
/* if(xx==6)
{
ajaxRequest.open("GET", "hrtripdetail.jsp", true);
}*/
...
<!--  <tr><td class="hed">Trip Details </td><td><a href='javascript:ajaxFunction(6);'><div id="tdetail"></div></a></td></tr>-->
</table>
<%
}
%>
...
Statement st3=con1.createStatement();
	...
	String tripid="", startdate="",startime="", status="",startplace="",endplace="",enddate="";
	int i=0;
...
side_bar_html +='<font size="2" face="arial" color="red" ><b>Transporter         :</b></font><font size="2" face="arial" color="#B22222" ><b><%= transporter%></b></font><br>';
	...
	side_bar_html +='<br><font size="2" color="red" face="arial"><b>Latest Trip Details</b></font><br>';
	
	String sql="SELECT * FROM t_startedjourney where startdate>='"+ fromdate1+"'and startdate<='"+todate1 +"' and vehregno='"+vehregno+"' order by startdate desc limit 1 ";
	...
	if(rst1.next())
	{
 		...
 		{
 			side_bar_html +='<br><font size="1" color="Black" face="arial"><b>Tripid  :<%= tripid%></b></font><br>';
 			side_bar_html +='<br><font size="1" color="Black" face="arial"><b>Starplace  :<%= startplace%></b></font><br>';
 			side_bar_html +='<br><font size="1" color="Black" face="arial"><b>Startdate  :<%= startdate%></b></font><br>';
 			side_bar_html +='<br><font size="1" color="Black" face="arial"><b>Endplace  :<%= endplace%></b></font><br>';
 			side_bar_html +='<br><font size="1" color="Black" face="arial"><b>Status: Running</b></font><br>';
 			
 		}
 		else
 		{
 			String sql1="SELECT * FROM t_completedjourney where startdate>='"+ fromdate1+"'and startdate<='"+todate1 +"'and vehregno='"+vehregno+"' order by startdate desc limit  ";
			...
			if(rst2.next())
			{
				...
				enddate=rst2.getString("Enddate");
 				...
 				side_bar_html +='<br><font size="1" color="Black" face="arial"><b>Startdate  :<%= startdate%></b></font><br>';
 				side_bar_html +='<br><font size="1" color="Black" face="arial"><b>Endplace  :<%= endplace%></b></font><br>';
 				side_bar_html +='<br><font size="1" color="Black" face="arial"><b>Enddate	:<%=enddate%></b></font><br>';
	
 		 	}
 		}
	}			//var marker1 = createMarker(point1,"<div class='bodyText'>Start Location  < %=thedate%> < %=thetime%> < %= location%></div>","<div class='bodyText'>< %= vehregno%><br>< %= thedate%> < %= thetime%><br> < %= location%></div>","SI",< %= lat%>,< %= lon%>);
          //  var marker2= createMarker(point1,"<div class='bodyText'>Start Location  < %=thedate%> < %=thetime%> < %= location%></div>","<div class='bodyText'>< %= vehregno%><br>< %= thedate%> < %= thetime%><br> < %= location%></div>","SI",< %= lat%>,< %= lon%>);
