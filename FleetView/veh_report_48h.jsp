...
{  
          ...
          document.veh48hrs.action ="excel.jsp";
          document.forms["veh48hrs"].submit();
 }  
</script>  
...
String vid="", sql="",sql1="",sql2="", transporter="", vehregno="", thedate1="", thedate2="";
...
try
{
	...
	String fourtyEightHoursPrevDatetime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(todaysDate);
...
%>
<form id="veh48hrs" name="veh48hrs" action="" method="post" >
...
<table width="100%" align="center" class="stats">
			...
			<font  size="3" ><b>Last 48 Hours Report</b></font></td>
			</tr>
			<tr>
			<td>
			<div align="center"><font  size="3"><b>Exception Report For <%=transporter%>, Vehicle <%=vehregno%> For The Period : <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(fourtyEightHoursPrevDatetime))%>  to <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(currentDateTime))%>  </b></font></div>
				<div align="right">
		...
		<a href="#" style="font-weight: bold; color: black; " onclick="gotoPrint('mytable');">    
 		...
 		</a><%=Utilities.printDate()%>
				</div>
			</td>
			</tr>
			</table>
			<table border="0" align="center" width="100%" class="stats">
			<tr>	<td align="center"><font size="3"><b>Over Speed</b></font></td>
	</tr>
	<tr>
		<td>
		<table width="100%" border="1" align="center" class="sortable">
			...
			<%
				...
				int numRecords = 0;
				try {
					currentRecord = vehicleDao.getOverSpeedData(fourtyEightHoursPrevDatetime, currentDateTime, vid);
	...
	<tr>
		...
		<table width="100%" border="1" align="center" class="sortable">
			...
			<%
						...
						int numRecords1 = 0;
						try {
							data = vehicleDao.getRapidAccelerationDetailsData(vid, fourtyEightHoursPrevDatetime, currentDateTime, "RapidAcceleration");
			...
			<tr>
				<td align="right"><div align="right"><%=counter+1 %></div></td>
				<td align="right"><div align="right"><%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(currentRecord1.getDate()))%> <%=currentRecord1.getTime()%></div></td>
				<td align="right">
...
<%
 ...
 %>
	...
	<tr>
		...
		int numRecords2 = 0;
		try {
			data1 = vehicleDao.getRapidAccelerationDetailsData(vid, fourtyEightHoursPrevDatetime, currentDateTime, "RapidDecceleration");
	...
	<tr>
		...
		try {
			data3 = vehicleDao.getContinuousDrivingDetailsData(
					vid, fourtyEightHoursPrevDatetime, currentDateTime, "Stops");
		...
		%>
			<tr>
				<td align="right"><div align="right"><%=counter+1 %></div></td>
				<td align="right">
				<div align="right"><%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(currentRecord3.getStartDate()))%> <%=currentRecord3.getStartTime()%></div>
				</td>
				<td align="right">
				<div align="right"><%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(currentRecord3.getEndDate()))%> <%=currentRecord3.getEndTime()%></div>
				</td>
				<td align="right">
		...
		<table width="100%" border="1" align="center" class="sortable">
			...
			try {
				data4 = vehicleDao.getContinuousDrivingDetailsData(
						vid, fourtyEightHoursPrevDatetime, currentDateTime, "NightDriving");
		...
		<table width="100%" border="1" align="center" class="sortable">
			...
			try {
				data5 = vehicleDao.getContinuousDrivingDetailsData(
						vid, fourtyEightHoursPrevDatetime, currentDateTime, "ContinuousDriving");
