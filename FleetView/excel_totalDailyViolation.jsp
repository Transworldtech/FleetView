...
String filename=session.getAttribute("user").toString()+showdatex+"TotaldailyViolation.xls";
...
try
{
	...
	//String Transporter=session.getAttribute("usertypevalue").toString();
			...
			{
				%>
				<tr><td colspan="2"><div class="bodyText" align="left"> 
				<font size="2"><b>Report No : 6.2.1</b></font></div></td></tr>
				<tr align="center"><td colspan="12"><b><font size="3">Daily Driving Hrs Violation Report from <%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(fromdate)) %> To <%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(todate)) %></font></b></td></tr>
