...
%>
<%
String todate=request.getParameter("fromdate1");
...
while(rs2.next())
	  { 
		...
		sql3="select * from t_veh"+vehcode+" where concat(TheFieldDataDate,' ',TheFieldDataTime) >= concat('"+fromdate+" 07:00:00') and concat(TheFieldDataDate,' ',TheFieldDataTime) <= concat('"+todate1+" 07:00:00') and TheFiledTextFileName='SI' order by concat(TheFieldDataDate,TheFieldDataTime) asc limit 1";
		//out.print(sql3);
	...
	//out.print("fd="+fd);
		...
		String sql4="select * from t_veh"+vehcode+" where concat(TheFieldDataDate,' ',TheFieldDataTime) <=concat('"+todate1+" 07:00:00') and concat(TheFieldDataDate,' ',TheFieldDataTime) >= concat('"+fromdate+" 07:00:00') and TheFiledTextFileName='SI' order by concat(TheFieldDataDate,TheFieldDataTime) desc limit 1 ";
		//out.print(sql4);
...
%>	
	<tr><td colspan="9" align="center"> <input type="button" name="Print" Value="Print" class="formElement" onclick="javascript:window.print();"></td></tr>
	</tr>
