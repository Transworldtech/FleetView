...
<!-- <tr><td><font color="block" size="3" >Report No: 10.3</font></td></tr>-->
...
<table border="0" width="60%">
	<tr align="center">
		<td><br>
		<font size="2"><b>Transporter-wise All JDData Trips From <%=data1%>
		to <%=data2%></b></font>
		<div align="right"><br>
		...
		<table border="1" width="100%" class="sortable">
			...
			<%
				sql = "Select distinct(Ownername),count(TripID) as TripID from t_alljddata where StartDate BETWEEN '"
									...
									+ "' and '"
									+ todate
									+ "'  group by ownername order by ownername Asc";
		...
		<table border="0" width="60%">
			<tr align="center">
				<td><br>
				<font size="2"><b>LocationWwise All JDData Trips From <%=data1%>
				to <%=data2%></b></font>
				<div align="right"><br>
				...
				<table border="1" width="60%" class="sortable">
					...
					<%
						sql = "Select distinct(StartPlace),count(TripID) as TripID from t_alljddata where StartDate BETWEEN '"
											...
											+ "' and '"
											+ todate
											+ "'  group by StartPlace order by StartPlace Asc";
				...
				<table border="0" width="60%">
					<tr align="center">
						<td><br>
						<font size="2"><b>All JDData Trips From <%=data1%> to <%=data2%></b></font>
						<div align="right"><br>
						...
						<table border="1" width="60%" class="sortable">
							...
							<%
								sql = "Select distinct(DriverCode),count(TripID) as TripiD,DriverName from t_alljddata where StartDate BETWEEN '"
													...
													+ "' and '"
													+ todate
													+ "'  group by DriverCode order by DriverName Asc";
						...
						<table border="0" width="100%">
							...
							<tr align="center">
								<td><font size="2"><b>All JDData Trips From <%=data1%>
								to <%=data2%></b></font>
								...
								<table border="1" width="100%" class="sortable">
									...
									<%
										sql = "Select TripID,VehRegNo,StartPlace,EndPlace,StartDate,DriverName,DriverCode,OwnerName,Category from t_alljddata where StartDate BETWEEN '"
															...
															+ "' and '"
															+ todate
															+ "'   group by TripId order by StartDate Asc";
