...
<table border="1" width="70%" align="center" class="sortable_entry">
<tr>
<td colspan="2"><font size="3"><div align="center"><b>Custom Trip Report</b></div></font></td>
</tr><tr>
<td>
<font size="2">
<b>Date Range</b>
...
<input type="hidden" name="trans" id="trans" value="Select">
<input type="hidden" name="transname" id="transname" value="<%=session.getAttribute("usertypevalue").toString()%>">
</font>
<td><font size="2">
<b>Origin</b>
</font>
...
/************ The Search Result Comes here *******************/
 data1=request.getParameter("data");
 	if(!(null==data1))
 	{
		...
		%>
		<div align="center"><font color="black" size="2">Castrol trip Report for <%=distrans%> <%=disorigin%> <%=disdest%> from <%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(data1))%> to <%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(data2))%></font></div>
		<div align="right">
		<a href="#" onclick="javascript:window.open('print_trans_searchtrip.jsp');" title="Print Current Position Report">
		<img src="images/print.jpg" width="15px" height="15px">
		</a>&nbsp; &nbsp; 
		<a href="excel_trans_searchtrip.jsp"  title="Export to Excel">
		<img src="images/excel.jpg" width="15px" height="15px">
</a>		
		 <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new java.util.Date())%></div>		
		<%  
		String heading="Castrol trip Report for "+distrans+" "+disorigin+" "+disdest+" from "+new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(data1))+" to "+new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(data2));		
	...
	{
		sql="select distinct(tripid),StartPlace,EndPlace,kmTravelled,startDate,EndDate,VehId,VehRegNo,DriverName,DriverId,OwnerName from t_completedjourney where StartDate >='"+data1 +" 00:00:00' and StartDate <='"+data2 +" 00:00:00' and GPName='Castrol' and OwnerName='"+trans2+"'";
	}
