...
sql="update db_gps.t_disconnectionData set ClosingComment='"+otherreason+"', violationstatus='Close',Closedatetime='"+sysdate22+"',ClosedBy='"+userid+"' where vehicleCode='"+vehid+"' and Reason='Disconnection' and ignoredstamp='No' and Duration >= '0:30' and OffTimeFrom='"+date+"'";
