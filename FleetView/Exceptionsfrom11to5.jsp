...
try{
	...
	%>
		...
		<%
		  	String oscount="",rdcount="",cdcount="",ndcount="",racount="",stopcount="";
			boolean flag=true;
		    ...
		    while(rs1.next())
		    {
				...
				while(rs7.next())
				{
					cdcount=rs7.getString(1);
					cdtot++;
				}
			if( oscount.equals("0") && rdcount.equals("0") && cdcount.equals("0") && ndcount.equals("0") &&racount.equals("0") &&stopcount.equals("0"))	
			{
