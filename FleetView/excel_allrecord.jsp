...
<% 
	...
	String filename=session.getAttribute("user").toString()+showdatex+"driver_rating_report.xls";
...
%>
	...
	<tr>
			...
			<td class="bodyText"><div align="right"><%=rst.getString("TripID")%></div></td>
