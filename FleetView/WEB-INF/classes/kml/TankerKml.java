...
public class TankerKml
{
	...
	public static void main(String args[])throws IOException
	{
	 ...
	 try
	 {
		 ...
		 Class.forName("org.gjt.mm.mysql.Driver");
			Connection conn1= DriverManager.getConnection("jdbc:mysql://192.168.2.55/db_gps","fleetview","1@flv");
	...
	filename="/home/shweta/Desktop/tankerEast.kml";
	String sql="select *  from jrmallroute where routeid=76 and trackid=1 limit 1";
	...
	String sql1="select  *  from jrmallroute where routeid=76 and trackid>1 order by trackid";
	...
	//	 String color=currentzone;
		...
		//if(trackid==186 || trackid==210 || trackid==237) //tankerwest
		if(trackid==27 || trackid==233) //tankerwest
		{
		...
		else if(!(prevzone.equalsIgnoreCase(color)))
		{
