...
import com.fleetview.beans.POICSVReader;
import com.fleetview.beans.POIExcelReader;
...
public class FileUpload {
	...
	public ArrayList<DisplayData> uploadFile(HttpServletRequest request,String directory,String user,String usertypevalue)  throws Exception,org.apache.commons.fileupload.FileUploadBase.FileSizeLimitExceededException {
						...
						if(fileName.length()>0 && !fileName.equalsIgnoreCase("null")){
						 ...
						 fileNameDb="xls file format";
							...
							if(fileName.length()>0 && !fileName.equalsIgnoreCase("null")){
								...
								item.write(new File(fileNameUpload));
								POICSVReader poiExample = new POICSVReader ();
								String         xlsPath    = fileNameUpload;
