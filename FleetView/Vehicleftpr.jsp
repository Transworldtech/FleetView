	...
	{  
	 ...
	 function birt(){
		 ...
		 */
			...
			document.getElementById("myIframe").src="http://myfleetview.com/birt/frameset?__report=vehicleftpr.rptdesign&usertypevalue="+user+"&Date1="+formattedDate1+"&Date2="+formattedDate2+"&dt="+date1+"&dt1="+date2+"&__showtitle=false";
	...
	%>
	 <table border="0" width=600 align="center" class="stats">
		<tr>
			...
			<font face="Arial" color="black" size="3"><b style= "font:normal 16px Arial,Helvtica,sans-serif;"><b> Vehicle FTPR Report </b></font></td>
		</tr>
	</table>
...
<div id="reportData1">
<iframe id="myIframe" width="100%" height="850px" src="http://myfleetview.com:8080/birt/frameset?__report=vehicleftpr.rptdesign?&Date1=<%=dt%>&Date2=<%=dt1%>&dt=<%=datex1%>&dt1=<%=datex2%>&__showtitle=false"> 
