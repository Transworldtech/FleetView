	...
	else
	{
		...
		{	
			...
			<div id="report_heding"><font size="3"> <b>Stopped Vehicle</b></font></div>
				<div align="right">
				<a href="#" onclick="javascript:window.open('printstopped.jsp');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; 
				<a href="excelstopped.jsp"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>
				<%=fleetview.PrintDate()%>
				</div>
			</td>
			</tr>
