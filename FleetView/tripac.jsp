...
ResultSet rst1=fleetview.getACforDateRange(startdate,enddate,vehid);
int i=1;
while(rst1.next())
{
%>
<tr>
<td><%=i %></td>
<td class="bodyText"><%= new SimpleDateFormat("dd-MMM-yyyy").format( new SimpleDateFormat("yyyy-MM-dd").parse(rst1.getString("TheFieldDataDate")))%>
