...
//alert("ajax 222");
	...
	//alert(queryString);
	ajaxRequest.open("POST", "Dvaccumajax.jsp" + queryString, true);
...
//			  	alert("in delete function");
			 	if(agree)
			     {
			            ...
			            // alert("before delete");
			            window.location="Dvaccumdelete.jsp?&rid="+id;
...
<br>
<br>
<div align="center" class="headerlay"><table style="color:#fff;"><tbody><tr><td><label id="element_1" name="element_1"  class="description" for="element_1"><font size="3" color="black"><b>Add Custom Field For Vacuum System</b></font> </label></td></tr></tbody></table></div>
...
<a href="EditDvaccum.jsp?VehId=<%=VehId%>&VehRegNo=<%=VehRegNo%>"><font color="Blue" size="2">Go Back</font></a>
</div>
...
<tr>
						...
						<% int j=1;
    String Sqlday="select * from db_gps.t_vaccumsystemforcustomfieldmaster where Owner='"+transporter+"' order by id";
