...
//date=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new SimpleDateFormat("dd-MMM-yyyy HH:mm").parse(date));
...
sql="update db_gpsExceptions.t_vehall_stsp set ClosingComment='"+otherreason+"', violationstatus='Close',Closedatetime='"+sysdate22+"',ClosedBy='"+userid+"' where VehCode='"+vehid+"' and  FromDatetime='"+date+"'";
