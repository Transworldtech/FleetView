...
String filename=session.getAttribute("user").toString()+showdatex+"veh_report_24_hours.xls";
...
try
{
	...
	thedate2=thedate1=new SimpleDateFormat("yyyy-MM-dd").format(NewDate);
...
<table width="100%" align="center" >
			...
			<td> <div align="center"><%=new SimpleDateFormat("dd-MMM-yyyy").format(rst4.getDate("ToDate"))%> <%=rst4.getString("ToTime")%></div></td>
