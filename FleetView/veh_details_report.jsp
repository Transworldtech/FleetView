...
<a href="#" onclick="javascript:window.open('print_veh_details_report.jsp?vehcode=<%=VehicleCode%>');" title="Print Report">
<img src="images/print.jpg" width="15px" height="15px">
</a>&nbsp; &nbsp; 
<a href="excel_veh_details_report.jsp?vehcode=<%=VehicleCode%>"  title="Export to Excel">
