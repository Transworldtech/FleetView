...
try
{
	...
	//String Transporter=session.getAttribute("usertypevalue").toString();
			...
			{
				%>
				<!-- <tr style="border:none"><td><font color="block" size="3" >Report No: 10.30</font></td></tr>-->
				...
				<tr align="center"><td><b><font size="3">Daily Driving Hrs Violation Report For Tanker :- <%=new SimpleDateFormat("MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(fromdate)) %></font></b></td></tr>
				 <tr><td>
			...
			<% 
		      	...
		      	{   %>
				<tr align="center"><td><b><font size="3">Daily Driving Hrs Violation Report For Primary :-  <%=new SimpleDateFormat("MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(fromdate)) %></font></b></td></tr>
				 <tr><td>
	 <div class="bodyText" align="right">
	 <a href="excel_drivinghrs1.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Primary&con=10"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
	 &nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.open('print_drivinghrs1.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Primary&con=10');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>
	 &nbsp;&nbsp;&nbsp;Date : <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new java.util.Date())%></div>
			...
			<tr align="center"><td><b><font size="3">Daily Driving Hrs Violation Report For Secondary :- <%=new SimpleDateFormat("MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(fromdate)) %></font></b></td></tr>
			<tr><td>
	       <div class="bodyText" align="right">
	    <a href="excel_drivinghrs1.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Secondary&con=10"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
	 &nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.open('print_drivinghrs1.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Secondary&con=10');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>
	 &nbsp;&nbsp;&nbsp;Date : <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new java.util.Date())%></div>
	</td></tr>
		...
		<%	}
			      ...
			      else 
			      {
			    	  if(category.equalsIgnoreCase("Tanker"))
						{  %>
			    			...
			    			<tr><td>
			    	       <div class="bodyText" align="right">
			    	    <a href="excel_drivinghrs1.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Tanker&con=12"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
			    	 &nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.open('print_drivinghrs1.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Tanker&con=12');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>
			    	 &nbsp;&nbsp;&nbsp;Date : <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new java.util.Date())%></div>
			    	</td></tr>
			    	 <%  }
			    	    else if(category.equalsIgnoreCase("Primary"))
			    	    {  %>
			    			...
			    			<tr><td>
			    	       <div class="bodyText" align="right">
			    	    <a href="excel_drivinghrs1.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Primary&con=12"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
			    	 &nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.open('print_drivinghrs1.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Primary&con=12');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>
			    	 &nbsp;&nbsp;&nbsp;Date : <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new java.util.Date())%></div>
			    	</td></tr>
			    	  ...
			    	  <%  }
			    	    else
			    	    {
			    			...
			    			<tr><td>
			    	       <div class="bodyText" align="right">
			    	    <a href="excel_drivinghrs1.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Secondary&con=12"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
			    	 &nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.open('print_drivinghrs1.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Secondary&con=12');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>
			    	 &nbsp;&nbsp;&nbsp;Date : <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new java.util.Date())%></div>
			    	</td></tr>
			...
			else if(thename.equals("ended"))
			{
				...
				<tr align="center"><td><b><font size="3">Daily Driving Hrs Violation Report For Tanker :- <%=new SimpleDateFormat("MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(fromdate)) %></font></b></td></tr>
				 <tr><td>
         	 <div class="bodyText" align="right">
	         <a href="excel_drivinghrs1.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Tanker&con=10"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
	        &nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.open('print_drivinghrs1.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&cg=Tanker&con=10');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>
	        &nbsp;&nbsp;&nbsp;Date : <%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new java.util.Date())%></div>
	       </td></tr>
			<% 
			  	     }
	...
	if(thename.equalsIgnoreCase("ended"))
	{
		...
		<%
				...
				else
				{
					if(category.equalsIgnoreCase("Tanker"))
					{
					sql="select * from t_driver_ds where TheDate between '"+fromdate+"' and '"+todate+"' and GPName='Castrol' and Category='Tanker' and RDurationinHrs>='12' order by TheDate Asc";
					}
					else if(category.equalsIgnoreCase("Primary"))
					{
						sql="select * from t_driver_ds where TheDate between '"+fromdate+"' and '"+todate+"' and GPName='Castrol' and Category='primary' and RDurationinHrs>='12' order by TheDate Asc";
					}
					else
					{
						sql="select * from t_driver_ds where TheDate between '"+fromdate+"' and '"+todate+"' and GPName='Castrol' and Category='secondary' and RDurationinHrs>='12' order by TheDate Asc";
					}
				}
