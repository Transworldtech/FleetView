...
%>
	...
	if(triptype.equalsIgnoreCase("started"))
	{
		...
		sql="SELECT TripID,DriverName,Driverid,brifdate,TrainerName,Remark FROM `t_briefing` WHERE tripid not in "+PSvehlist+" and brifdate between '"+fromdate+"' and '"+todate+"'";
