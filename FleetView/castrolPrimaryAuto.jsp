...
<tr><td align="left" colspan="2"><!-- <div align="left"><font size="3" >Report No: 10.21</font></div>--></td></tr>
<tr align="center">
<td>
...
try
{
	...
	if(!(null==sortby))
	{
	 ...
	 <a href="excel_primaryauto.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&sortby=<%=sortby%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
	 &nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.open('print_primaryauto.jsp?fromdate=<%=fromdate%>&todate=<%=todate%>&thename=<%=thename%>&sortby=<%=sortby%>');" title="Print Current Position Report"><img src="images/print.jpg" width="15px" height="15px"></a>
				...
				//	System.out.println(sqll1);
					...
					while(rstt1.next())
					{
						...
						vehcountall=vehcountall+rstt1.getInt("Vehid");
								...
								String lvsql="select count(TripID) as Trips from t_CastrolTripsEnded where TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and   StartPlace='"+startplace+"' and Category='Primary'  and  EndedBy='-'    and tripenddate<>'NA' and   KmTraveled<>'0'   and  (OSCount>'0' or  RACount>'0' or RDCount>'0') ";
								//System.out.println(sqll);
					...
					<tr>
					<td><%=k%></td>
					<td><div align="left"><a href="#" onclick="javascript:window.open('LocationwisePrimaryAuto.jsp?startplace=<%=startplace.replace("&","and")%>&date1=<%=fromdate %>&date2=<%=todate %>&triptype=<%=thename%>');"><%=startplace%></a>
					</div></td>
				...
				<td  class="hed"> Rating</td>
					...
					while(rstt.next())
					{
						...
						vehcountall=vehcountall+rstt.getInt("Vehid");
								...
								String vsql="select count(TripID) as Trips from t_CastrolTripsEnded where TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and   Transporter='"+startplace+"' and Category='Primary'  and  EndedBy='-'    and tripenddate<>'NA' and   KmTraveled<>'0'   and (OSCount>'0' or  RACount>'0' or RDCount>'0') ";
								//System.out.println(sqll);
					...
					<tr>
					<td><%=k%></td>
					<td><div align="left"><a href="#" onclick="javascript:window.open('driverwisePrimaryAuto.jsp?startplace=<%=startplace.replace("&","and")%>&date1=<%=fromdate %>&date2=<%=todate %>&triptype=<%=thename%>');"><%=startplace%></a>
					</div></td>
				...
				//	System.out.println(sqll);
					...
					while(rstt.next())
					{
						...
						vehcountall=vehcountall+rstt.getInt("Vehid");
								...
								String lvsql="select count(TripID) as Trips from t_CastrolTripsStarted where TripStartDate  between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and   StartPlace='"+startplace+"' and Category='Primary'  and  EndedBy='-'    and tripenddate<>'NA' and   KmTraveled<>'0' and (OSCount>'0' or  RACount>'0' or RDCount>'0') ";
								//System.out.println(sqll);
								ResultSet lvrst=st.executeQuery(lvsql);
								while(lvrst.next())
								{
			...
			//	System.out.println(sqll);
				...
				while(rstt.next())
				{
					...
					vehcountall=vehcountall+rstt.getInt("Vehid");
							...
							String lvsql="select count(TripID) as Trips from t_CastrolTripsStartEnded  where TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59'  and   StartPlace='"+startplace+"' and Category='Primary'  and  EndedBy='-'    and tripenddate<>'NA' and  KmTraveled<>'0'    and (OSCount>'0' or  RACount>'0' or RDCount>'0') ";
							//System.out.println(sqll);
							ResultSet lvrst=st.executeQuery(lvsql);
							while(lvrst.next())
							{
