...
<!--<tr><td align="left"><div align="left"><font size="3" face="Arial">Report No: 10.16.1</font></div></td></tr>-->
<tr><td  align="center">
<%

%>
<font size="3" face="Arial"><b>Trip Report for <%=startplace%> from <%=data%> to <%=data1%></b></font>
<div align="right">
				<a href="#" onclick="javascript:window.open('print_transporterprimary.jsp?startplace=<%=startplace.replace("&","and")%>&date1=<%=data %>&date2=<%=data1 %>&triptype=<%=triptype%>');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; 
				<a href="excel_transporterprimary.jsp?startplace=<%=startplace.replace("&","and")%>&date1=<%=data %>&date2=<%=data1 %>&triptype=<%=triptype%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>
...
<table border="1" width="100%" class="sortable">
			...
			if(triptype.equalsIgnoreCase("Started"))
			{
				...
				String sql11="Select count(CD) as cdcount1 from t_CastrolTripsStarted where CD='Yes' and TripStartDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Primary' and status<>'Faulty' and Transporter='"+startplace+"'";
				...
				String sql12="Select count(ND) as ndcount1 from t_CastrolTripsStarted where ND='Yes' and TripStartDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Primary' and status<>'Faulty' and Transporter='"+startplace+"'";
				...
				String sql13="Select count(Briefing) as bcount1 from t_CastrolTripsStarted where Briefing='briefed' and TripStartDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Primary' and status<>'Faulty' and Transporter='"+startplace+"'";
				...
				String sql14="Select count(Debriefing) as dbcount1 from t_CastrolTripsStarted where Debriefing='Yes' and TripStartDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Primary' and status<>'Faulty' and Transporter='"+startplace+"'";
				...
				String sqlall="Select * from t_CastrolTripsStarted where TripStartDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Primary' and status<>'Faulty' and Transporter='"+startplace+"'";
				...
				while(rstall.next())
				{
					...
					<td><div align="left"><%=drivername %></div></td>
					<td><div align="left"><%=startplace1 %></div></td>
					<td><div align="right">
			...
			else if(triptype.equalsIgnoreCase("ended"))
			{
				...
				String sql11="Select count(CD) as cdcount1 from t_CastrolTripsEnded where CD='Yes' and TripEndDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Primary' and status<>'Faulty' and Transporter='"+startplace+"'";
				ResultSet rstcd=st.executeQuery(sql11);
				if(rstcd.next())
				{
					//cdcount=rstcd.getInt("cdcount1");
				...
				String sql12="Select count(ND) as ndcount1 from t_CastrolTripsEnded where ND='Yes' and TripEndDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Primary' and status<>'Faulty' and Transporter='"+startplace+"'";
				ResultSet rstnd=st.executeQuery(sql12);
				if(rstnd.next())
				{
					//ndcount=rstnd.getInt("ndcount1");
				...
				String sql13="Select count(Briefing) as bcount1 from t_CastrolTripsEnded where Briefing='briefed' and TripEndDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Primary' and status<>'Faulty' and Transporter='"+startplace+"'";
				ResultSet rstb=st.executeQuery(sql13);
				if(rstb.next())
				{
					//bcount=rstb.getInt("bcount1");
				...
				String sql14="Select count(Debriefing) as dbcount1 from t_CastrolTripsEnded where Debriefing='Yes' and TripEndDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Primary' and status<>'Faulty' and Transporter='"+startplace+"'";
				ResultSet rstdb=st.executeQuery(sql14);
				if(rstdb.next())
				{
					//dbcount=rstdb.getInt("dbcount1");
				...
				String sqlall="Select * from t_CastrolTripsEnded where TripEndDate between '"+data+" 00:00:00' and '"+data1+" 23:59:59' and Category='Primary' and status<>'Faulty' and Transporter='"+startplace+"'";
				ResultSet rstall=st1.executeQuery(sqlall);
				while(rstall.next())
				{
...
<!--			</td></tr>-->
	...
	<td><div align="left"><%=briefdone%></div></td>
	<td><div align="left"><%=brieftrainername%></div></td>
	<td><div align="left"><%=briefcomment%>v</td>
	<td><div align="left"><%=debriefdone%></div></td>
	<td><div align="left"><%=debrieftrainername%></div></td>
	<td><div align="left"><%=debriefcomment%></div></td>
	<td><div align="right">
	...
	<%
		...
		//		System.out.println(sqll);
				...
				String sql11="Select count(CD) as cdcount1 from t_CastrolTripsStartEnded where CD='Yes' and TripStartDate>='"+data+" 00:00:00' and TripEndDate<='"+data1+" 23:59:59' and Category='Primary' and status<>'Faulty' and Transporter='"+startplace+"'";
				ResultSet rstcd=st.executeQuery(sql11);
				if(rstcd.next())
				{
					//cdcount=rstcd.getInt("cdcount1");
				...
				String sql12="Select count(ND) as ndcount1 from t_CastrolTripsStartEnded where ND='Yes' and TripStartDate>='"+data+" 00:00:00' and TripEndDate<='"+data1+" 23:59:59' and Category='Primary' and status<>'Faulty' and Transporter='"+startplace+"'";
				ResultSet rstnd=st.executeQuery(sql12);
				if(rstnd.next())
				{
					//ndcount=rstnd.getInt("ndcount1");
				...
				String sql13="Select count(Briefing) as bcount1 from t_CastrolTripsStartEnded where Briefing='briefed' and TripStartDate>='"+data+" 00:00:00' and TripEndDate<='"+data1+" 23:59:59' and Category='Primary' and status<>'Faulty' and Transporter='"+startplace+"'";
				ResultSet rstb=st.executeQuery(sql13);
				if(rstb.next())
				{
					//bcount=rstb.getInt("bcount1");
				...
				String sql14="Select count(Debriefing) as dbcount1 from t_CastrolTripsStartEnded where Debriefing='Yes' and TripStartDate>='"+data+" 00:00:00' and TripEndDate<='"+data1+" 23:59:59' and Category='Primary' and status<>'Faulty' and Transporter='"+startplace+"'";
				ResultSet rstdb=st.executeQuery(sql14);
				if(rstdb.next())
				{
					//dbcount=rstdb.getInt("dbcount1");
				...
				String sqlall="Select * from t_CastrolTripsStartEnded where TripStartDate>='"+data+" 00:00:00' and TripEndDate<='"+data1+" 23:59:59' and Category='Primary' and status<>'Faulty' and Transporter='"+startplace+"'";
				ResultSet rstall=st1.executeQuery(sqlall);
				while(rstall.next())
				{
