...
<% 
	...
	System.out.println("VegRegNo insert querry page *********:-"+VehRegNo);
...
ResultSet rst=null;
	...
	try{
			    ...
			    String insrtmaster="insert into db_gps.t_vaccumpump (Vehcode,Type,Make,Owner,Model,Capacity,insertDate,Serial_Number, oil_grade,oil_capacity ,drive,vaccum_pressure_rating,power_rpm,installation,pump_rotation,weight,no_four_way_valve,no_of_NRV,no_of_VRV,cooling_system,Entryby ) values('"+vehid+"','"+Type+"','"+Make+"','"+transporter+"','"+Model+"','"+Capacity+"','"+Date4+"','"+Serial_Number+"','"+Oil_Grade+"','"+Oil_Capacity+"','"+Drive1+"','"+vaccum_pressure_rating+"','"+power+"','"+installation+"','"+pump_rotation+"','"+weight+"','"+No_of_four_way_valve+"','"+No_Of_NRV+"','"+No_Of_VRV+"','"+Cooling_System+"','"+user+"') ";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 	 ...
 	 {
 		 //cnt=0;
 	out.println("<script type='text/javascript'>alert('Vacuum Record Inserted Successfully');");
 	...
 	out.println("</script>");
 		  ...
 		  out.println("<script type='text/javascript'>alert('Record Already Present For This Vehicle')");
 			//out.println("location='showperipheralsDet.jsp'");
 			 //response.sendRedirect("showperipheralsDet.jsp?VehId="+vehid+"&VehRegNo="+VehRegNo);
 			 out.println("location='showperipheralsDet.jsp?VehId="+vehid+"&VehRegNo="+VehRegNo+"'");
 			out.println("</script>");
