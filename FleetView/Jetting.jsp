...
System.out.println("VehRegNo on Pto insertpage---->"+VehRegNo);
...
<form name="userform" action="jettingpumpinsert.jsp" method="post" onsubmit="return formValidation();">
<br>
<br>
...
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b><font size="2" color="red">*</font>Serial Number</b> </label><input id="element_3_5" name="element_3_5"  class="element text medium" type="text"  value=""/><br><label id="element_error_5"></label><br><br><!--3,1--></td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Drive</b> </label><input id="element_3_6" name="element_3_6"  class="element text medium" type="text"  value=""/><br><label id="element_error_6"></label><br><br><br><!--3,2--></td>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Type</b> </label><input id="element_3_7" name="element_3_7"  class="element text medium" type="text"  value=""/><br><label id="element_error_7"></label><br><br><br><!--4,1--></td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Jetting Pressure Rating</b> </label><input id="element_3_8" name="element_3_8"  class="element text medium" type="text"  value=""/><br><label id="element_error_8"></label><br><br><br><!--4,2--></td>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Power</b> </label><input id="element_3_9" name="element_3_9"  class="element text medium" type="text"  value=""/><br><label id="element_error_9"></label><br><br><br><!--5,1--></td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Suction Strainer </b> </label><input id="element_3_10" name="element_3_10"  class="element text medium" type="text"  value=""/><br><label id="element_error_10"></label><br><br><br><!--5,2--></td>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Rotation</b> </label><input id="element_3_11" name="element_3_11"  class="element text medium" type="text"  value=""/><br><label id="element_error_11"></label><br><br><br><!--6,1--></td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Piston Size</b> </label><input id="element_3_12" name="element_3_12"  class="element text medium" type="text"  value=""/><br><label id="element_error_12"></label><br><br><br><!--6,2--></td>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Seal Size</b> </label><input id="element_3_13" name="element_3_13"  class="element text medium" type="text"  value=""/><br><label id="element_error_13"></label><br><br><br><!--7,1--></td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Accumulator Make</b> </label><input id="element_3_14" name="element_3_14"  class="element text medium" type="text"  value=""/><br><label id="element_error_14"></label><br><br><br><!--7,2--></td>
</tr>
<tr>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b>Model No</b> </label><input id="element_3_15" name="element_3_15"  class="element text medium" type="text"  value=""/><br><label id="element_error_15"></label><br><br><br><!--8,1--></td>
<td><label id="element_1" name="element_1"  class="description" for="element_1"><b><font size="2" color="red">*</font>Cooler</b> </label><input id="element_3_16" name="element_3_16"  class="element text medium" type="text"  value=""/><br><label id="element_error_16"></label><br><br><!--8,2--></td>
