...
try {
	...
	if(cnt.equals("3"))
	{
		...
		if(rstdist.next())
		{
			...
			double weekrate1=0.0,weekrate2=0.0,weekrate3=0.0,weekrate4=0.0,weekrate5=0.0,weekrate6=0.0;
			int j=0;
		...
		sql1="select avg(TripRating) as Rating from t_completedjourney where JDcode in "+jcode+" and StartDate >=(DATE_ADD('"+newdate2+"',INTERVAL 5 MONTH)) and StartDate <='"+newdate1+"'";
