...
%>
<%!
Statement st=null;Statement st41=null;
Statement st42=null;Connection conn=null;
...
<%int counter=0;
	...
	final String str_list=session.getAttribute("Str_os").toString();
	
	// final String str_list = request.getParameter("str_os");
	 final String str = request.getParameter("count");
	 int num=Integer.parseInt(str);
	String uname=session.getAttribute("user").toString();
	//System.out.println("\n\n\n\n\n\nlist42---->>>"+ session.getAttribute("Str_os").toString());
	//System.out.println("\n\n\n\n\n\nlist---->>>"+str_list);
	//System.out.println("\n\n\n\n\n\nlist---->>>"+session.getAttribute("User").toString());
...
String  exportFileName=session.getAttribute("user").toString()+"_total_os.xls";
...
// string tokens...
	...
	String ss=session.getAttribute("Str_os").toString();
...
//			System.out.println("\n\n\n\nvehical numer--->>>>"+vehregno);
	...
	if(data1.length()>12)
	{
		...
		//query="SELECT os.Duration, os.FromDate, os.FromTime, os.ToDate, os.ToTime," +
		//"       veh.LatinDec, veh.LonginDec, veh.TheFieldSubject, veh.Distance, os.Speed, veh.ZoneColor" +
		/*"  FROM db_gpsExceptions.t_veh"+aa+"_overspeed os " +
		" LEFT OUTER JOIN (" +
		...
		"WHERE 1=1 " +
		" AND os.ToDate>='"+new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(data1))+ "'" +
		" AND os.ToDate<='"+new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(data2))+ "'" +
		...
		"     FROM  db_gps.t_veh"+aa +
		"  WHERE  TheFiledTextFileName= 'OS' " +
		"  and TheFieldDataDateTime >= '"+new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(data1))+ "' "+
		"  and TheFieldDataDateTime <= '"+new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(data2))+"' "+
		...
		"   AND veh.TheFieldDataTime = os.FromTime)" +
		"WHERE 1=1 " +
		" AND os.ToDate>='"+new SimpleDateFormat("yyyy-MM-dd").format(new SimpleDateFormat("yyyy-MM-dd").parse(data1))+ "'" +
		" AND os.ToDate<='"+new SimpleDateFormat("yyyy-MM-dd").format(new SimpleDateFormat("yyyy-MM-dd").parse(data2))+ "'" +
		"ORDER BY concat(os.FromDate,os.FromTime)";*/
		...
		"     FROM  db_gps.t_veh"+aa +
		"     WHERE  TheFiledTextFileName= 'OS'" +
		" and TheFieldDataDate >= '"+new SimpleDateFormat("yyyy-MM-dd").format(new SimpleDateFormat("yyyy-MM-dd").parse(data1))+"' "+
		" and  TheFieldDataDate <= '"+new SimpleDateFormat("yyyy-MM-dd").format(new SimpleDateFormat("yyyy-MM-dd").parse(data2))+"' "+
		"     GROUP BY TheFieldDataDateTime" +
		") veh ON (veh.TheFieldDataDate = os.FromDate" +
		"   AND veh.TheFieldDataTime = os.FromTime)" +
		"WHERE 1=1 " +
...
%>
				...
				<td>
				<div align="right"><%=rstcounts.getString("Speed") %></div>
				</td>
				<td>
