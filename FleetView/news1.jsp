...
{
 window.open(webadd,'jav','width=400,height=300,resizable=yes');
} 
</SCRIPT>
...
height=129 cellSpacing=0 cellPadding=0 width=100 border=0>
  <TBODY>
<TR>
    <TD vAlign=top width=0 height=1></TD>
...
while(rs1.next())
{ 
  String webadd=rs1.getString("WebAdd");
  %>
  
  <TR>
    <TD vAlign=top width=0 height=1></TD>
    <TD align=justify width=50 height=1>
   
         <p align="justify">
   
          <ul> <li> <b><a href="<%=rs1.getString("WebAdd") %>"  onClick="newwindow('<%= webadd %>');return false" target="_parent"><font face="Verdana" size="2" color="#354422"> <%=rs1.getString("Headlines") %>&nbsp; </font></b><font face="Verdana" size="1" color="#FF0000">More 
...
<TR>
 ...
 &nbsp;&nbsp;   <TD align=justify width=400 height=1>
