...
sql="update db_gpsExceptions.t_vehall_ds set OverrideComents='"+otherreason+"', OverrideStatus='Close',OverrideBy='"+userid+"',OverrideDateTime='"+sysdate22+"' where vehcode='"+vehid+"' and RDuration > '10:00:00' and thedate='"+date+"'";
...
if(ins>=1){
	...
	String sqlup="insert into db_gpsExceptions.t_override_rh select * from db_gpsExceptions.t_vehall_ds where vehcode='"+vehid+"' and RDuration > '10:00:00' and thedate='"+date+"'";
	System.out.println(sqlup);
	st2.executeUpdate(sqlup);
	
	sql = "Update db_gps.t_completedjourney set DIStatus = 'Pending'  where ((startdate <= '"+date+" 00:00:00'  and enddate >= '"+date+" 23:59:59')  or (startdate >= '"+date+" 00:00:00'  and  enddate <= '"+date+" 23:59:59')) and vehid = '"+vehid+"' ";
