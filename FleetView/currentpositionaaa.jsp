...
{
	var popup1 = document.getElementById("popup1"+id);
	if (show) {
...
<tr><td colspan="3" class="bodyText"><marquee><font color="red" size="2" >Note: </font><font color="green" size="2">You can End the Trip by clicking on Trip Id.</font></marquee></td></tr>
<tr>
...
<%	String inserted=request.getParameter("inserted");
  	...
  	{ %>
  		...
  		<tr>
  		     <td> <div align="center"> <font color="maroon"> <b>  Successfuly inserted </B> </font> </div> </td>
  		</tr>
	    </table>
<%      } %>
  </td>
...
<td class="bodyText" id="tdd<%=i%>">
		...
		<table border="1" bgcolor="white">
		   ...
		   <tr>
			<td> <a href="javascript: flase" onClick="window.open ('endtrip.jsp?tripid=<%=rsttrip.getString("TripId")%>', 'win1', 'width=400, height=250, location=0, menubar=0, scrollbars=0, status=0, toolbar=0, resizable=0'); javascript:toggleDetails1(<%=i%>,false);">End Trip </a>
			</td>
		   </tr>
...
{
%>
<td  id="tdd<%=i%>"><a href="tripstart.jsp?vehno=<%=rst.getString("VehicleRegNo")%>">Enter</a></td>
<td  id="tde<%=i%>"><a href="tripstart.jsp?vehno=<%=rst.getString("VehicleRegNo")%>">Enter</a></td>
<td  id="tda<%=i%>"><a href="tripstart.jsp?vehno=<%=rst.getString("VehicleRegNo")%>">Enter</a></td>
<td  id="tdb<%=i%>"><a href="tripstart.jsp?vehno=<%=rst.getString("VehicleRegNo")%>">Enter</a></td>
<td  id="tdc<%=i%>"><a href="tripstart.jsp?vehno=<%=rst.getString("VehicleRegNo")%>">Enter</a></td>
<%
}
