...
<% 
	...
	String filename=session.getAttribute("user").toString()+showdatex+"CastrolNDTotalTrip_Report.xls";
	   ...
	   if(!(null==triptype))
		{
				...
				{
					%>
					<tr><td><font size="2"><b><center>Report for ND Total Trips from <%=data1%> to <%=data2 %> (Started)</center></b></font></td></tr>
				...
				{
					%>
					<tr><td><font size="2"><b><center>Report for ND Total Trips from <%=data1%> to <%=data2%> (Ended)</center></b></font></td></tr>
				...
				{
					%>
					<tr><td><b><font size="2"><b><center>Report for ND Total Trips from <%=data1%> to <%=data2%> (Started and Ended)</center></b></font></td></tr>
...
try{
		...
		//	sql9="select count(*) as ndall from t_CastrolTripsStartEnded where TripStartDate >= '"+fromdate+" 00:00:00' and TripEndDate <= '"+todate+" 23:59:59' and ND = 'Yes' and status<>'Faulty'";
			...
			while(rstt.next())
			{
				...
				vehcountall=rstt.getInt("Vehid");
						...
						String sql11="Select count(CD) as cdcount1 from t_CastrolTripsStarted where CD='Yes' and TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and status<>'Faulty' and ND='Yes'";
						...
						/*String sql12="Select count(ND) as ndcount1 from t_CastrolTripsEnded where ND='Yes' and TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and status<>'Faulty'";
						...
						String sql13="Select count(Briefing) as bcount1 from t_CastrolTripsStarted where Briefing='briefed' and TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and status<>'Faulty' and ND='Yes'";
						...
						String sql14="Select count(Debriefing) as dbcount1 from t_CastrolTripsStarted where Debriefing='Yes' and TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and status<>'Faulty' and ND='Yes'";
						...
						String sqlall="Select * from t_CastrolTripsStarted where TripStartDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and status<>'Faulty' and ND='Yes'";
						...
						while(rstall.next())
						{
							...
							auto_manl=rstall.getString("EndedBy");
							///////////////////////////////////
			...
			<!-- Auto or manual closed for startedtrip type-->
		<td><%
		
		if(auto_manl.equals("-") || auto_manl.equals(""))
		{
		...
		else if(triptype.equalsIgnoreCase("ended"))
		{
			...
			//sqll="select Distinct(StartCode) from t_completedjourney where EndDate>= '"+fromdate+"' and EndDate <='"+todate+"' and GPName='Castrol' order by StartPlace Asc";
			String sqll="select count(TripID) as TripID,count(Distinct(DriverID)) as DriverID,count(Distinct(Vehid)) as Vehid,sum(KmTraveled) as KmTraveled,sum(OSCount) as OSCount,sum(OSDusration) as OSDuration,sum(RACount) as RACount,sum(RDCount) as RDCount,sum(ND) as NDCount  from t_CastrolTripsEnded where TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and status<>'Faulty' and ND='Yes'";
			//System.out.println(sqll);
			ResultSet rstt=stt.executeQuery(sqll);
			while(rstt.next())
			{
				...
				vehcountall=rstt.getInt("Vehid");
						...
						String sql11="Select count(CD) as cdcount1 from t_CastrolTripsEnded where CD='Yes' and TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and status<>'Faulty' and ND='Yes'";
						ResultSet rstcd=st.executeQuery(sql11);
						if(rstcd.next())
						{
							//cdcount=rstcd.getInt("cdcount1");
						...
						String sql13="Select count(Briefing) as bcount1 from t_CastrolTripsEnded where Briefing='briefed' and TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and status<>'Faulty' and ND='Yes'";
						ResultSet rstb=st.executeQuery(sql13);
						if(rstb.next())
						{
							//bcount=rstb.getInt("bcount1");
						...
						String sql14="Select count(Debriefing) as dbcount1 from t_CastrolTripsEnded where Debriefing='Yes' and TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and status<>'Faulty' and ND='Yes'";
						ResultSet rstdb=st.executeQuery(sql14);
						if(rstdb.next())
						{
							//dbcount=rstdb.getInt("dbcount1");
						...
						String sqlall="Select * from t_CastrolTripsEnded where TripEndDate between '"+fromdate+" 00:00:00' and '"+todate+" 23:59:59' and status<>'Faulty' and ND='Yes'";
						ResultSet rstall=st1.executeQuery(sqlall);
						while(rstall.next())
						{
		...
		else
		{
			...
			//sqll="select Distinct(StartCode) from t_completedjourney where EndDate>= '"+fromdate+"' and EndDate <='"+todate+"' and GPName='Castrol' order by StartPlace Asc";
			String sqll="select count(TripID) as TripID,count(Distinct(DriverID)) as DriverID,count(Distinct(Vehid)) as Vehid,sum(KmTraveled) as KmTraveled,sum(OSCount) as OSCount,sum(OSDusration) as OSDuration,sum(RACount) as RACount,sum(RDCount) as RDCount,sum(ND) as NDCount  from t_CastrolTripsStartEnded where TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59' and status<>'Faulty' and ND='Yes'";
			//System.out.println(sqll);
			ResultSet rstt=stt.executeQuery(sqll);
			while(rstt.next())
			{
				...
				vehcountall=rstt.getInt("Vehid");
						...
						String sql11="Select count(CD) as cdcount1 from t_CastrolTripsStartEnded where CD='Yes' and TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59' and status<>'Faulty' and ND='Yes'";
						ResultSet rstcd=st.executeQuery(sql11);
						if(rstcd.next())
						{
							//cdcount=rstcd.getInt("cdcount1");
						...
						String sql13="Select count(Briefing) as bcount1 from t_CastrolTripsStartEnded where Briefing='briefed' and TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59' and status<>'Faulty' and ND='Yes'";
						ResultSet rstb=st.executeQuery(sql13);
						if(rstb.next())
						{
							//bcount=rstb.getInt("bcount1");
						...
						String sqlall="Select * from t_CastrolTripsStartEnded where TripStartDate>='"+fromdate+" 00:00:00' and TripEndDate<='"+todate+" 23:59:59' and status<>'Faulty' and ND='Yes'";
						ResultSet rstall=st1.executeQuery(sqlall);
						while(rstall.next())
						{
