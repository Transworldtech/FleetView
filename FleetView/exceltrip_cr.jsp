...
String filename=session.getAttribute("user").toString()+showdatex+"trip_cr.xls";
...
%>
<table class="stats">
<tr><th><font size="3">CONTINUOUS DRIVING Report for Driver <%=drivername+"("+drivercode+")"%> ,TripID :<%=tripid%> <div align="right" >
Date : <%
