...
String filename=session.getAttribute("user").toString()+showdatex+"stops.xls";
...
<%
	...
	while(rst.next())
	{
		...
		<td><div align="left"><%=fleetview.ShowLocationOnlyByDateTime(vid,rst.getString("FromDate"),rst.getString("FromTime")) %></div></td>
		</tr>
		<%
		i++;
	}
