...
<tr><td><b>From</b>&nbsp;&nbsp;
<input type="text" id="data" name="data"  value="<%=fidDate%>"  size="15" readonly/>
...
<td>
<b>To</b>&nbsp;&nbsp;
<input type="text" id="data1" name="data1"  value="<%=fidDate%>" size="15" readonly/>
...
out.print(showdate1);
%>. <div align="right">
<a href="#" onclick="javascript:window.open('printnontrip_report.jsp?data=<%=data1%>&data1=<%=data2%>');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; <a href="excelnontrip_report.jsp?data=<%=data1%>&data1=<%=data2%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>&nbsp;&nbsp;&nbsp;Date : <%
