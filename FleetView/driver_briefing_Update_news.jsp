...
try{
	...
	String news="";
	 sql1="select Newsletter from db_gps.t_briefing where Driverid='"+DriveId+"' and Newsletter not in ('',' ','-')";
...
sql="update db_gps.t_briefing set Newsletter='"+inci+"' where Driverid='"+DriveId+"' and  Briefid ='"+BrifId+"'";
