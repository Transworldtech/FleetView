...
<a href="#" onclick="javascript:window.open('printoverspeed.jsp?dd=<%=request.getParameter("dd")%>');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; <a href="exceloverspeed.jsp?dd=<%=request.getParameter("dd")%>" title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>&nbsp;&nbsp;&nbsp;
<%=fleetview.PrintDate() %>
</div>
</td></tr>
</table>
...
<%
	...
	<td><div align="left"><%=fleetview.ShowOnMapOnlyByDateTime(vid,dd,rst.getString("FromTime")) %></div></td>
	</tr>
		<%
		i++;
	}
