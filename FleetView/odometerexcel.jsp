...
%>
					...
					<td class="bodyText" align="right">
						...
						if(totalfuel!=0.0){
							%>
							<td class="bodyText" align="right"><div align="right"><%=totalfuel1%></div></td>
							<%
						}else{
							%>
			...
			if(showhide.equalsIgnoreCase("Hide Avg")) {
						...
						<td class="bodyText" id="tda<%=i-1%>" align="left" style="display: none;">
						<div align ="right"><%=fulltank%></div>
						
						</td>
						<td class="bodyText" id="tdb<%=i-1%>" align="left" style="display: none;">
						<div align="right"><%=odoavgdis%></div>
						</td>
						<td class="bodyText" id="tdc<%=i-1%>" align="left" style="display: none;">
						...
						<td class="bodyText" id="tdp<%=i-1%>" align="left" style="width: 30px;display: none;">
						<div align="left"><%=fulltank%></div>
						</td>
						<td class="bodyText" id="tdq<%=i-1%>" align="left" style="width: 30px;display: none;">
						<div align="left">NA</div>
						</td>
						<td class="bodyText" id="tdr<%=i-1%>" align="left" style="width: 30px;display: none;">
						<div align="left">NA</div>
						</td>						
						<%} %>
						
						
						<td class="bodyText" id="manager<%=i-1%>" align="left" style="width: 30px;display: none;">
