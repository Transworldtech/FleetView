...
<script type="text/javascript">
	...
	{  
	    ...
	    document.veh7dreport.action ="excel.jsp";
	    document.forms["veh7dreport"].submit();
	} 
</script>
<form id="veh7dreport" name="veh7dreport" action="" method="post">
...
try
{
	...
	for (int counter = 0; counter < numRecords11; counter++)
	{
	   ...
	   String exportFileName=session.getAttribute("user").toString()+"_7DaysReport.xls";
