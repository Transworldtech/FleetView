...
%>
<%
Vehi = request.getParameter("a");
Vreg =  request.getParameter("b");
//Vehi = "1234";
//Vreg =  "MY";
...
<input type="hidden" id="Vehi" name="Vehi" value="<%=Vehi%>"></input>
<input type="hidden" id="Vreg" name="Vreg" value="<%=Vreg%>"></input>
<table class="stats">
<tr><td><font size="3" color="black" face="Arial"><b>Sensor Report</b></font></td></tr>
			...
			if(a==true)
				{
 	  			...
 	  			var Vreg=document.getElementById("Vreg").value;
 	  			//alert("own"+owner);
...
// 	  			document.getElementById('myIframe').src="http://103.8.126.138:8080/birt/frameset?__report=driverreport1.rptdesign&_title='My Viewer'&date1=2015-03-01&date2=2015-08-28&drivername="+driver+"";
 	  			document.getElementById("myIframe").src="http://myfleetview.com:8080/birt/frameset?__report=ProcessSensorData.rptdesign&Dt="+fromDateTime+"&Dt1="+toDateTime+"&Veh="+Vehi+"&Vehreg="+Vreg+"&Date1="+fromDateTime1+"&Date2="+toDateTime1+"&__showtitle=false";
  	...
  	<table border="0"  width=600  align="center">
			...
			%><font color="black" face="Arial" size="2"><b>From&nbsp;&nbsp;</b></font>
...
<!--				-->
<!--			</td>-->
			<td><font color="black" face="Arial" size="2"><b>To&nbsp;&nbsp;</b></font>
...
<div id="reportData1">
<iframe id="myIframe" width="100%" height="850px" src="http://myfleetview.com:8080/birt/frameset?__report=ProcessSensorData.rptdesign&Dt=<%=dat1%>&Dt1=<%=dat2%>&Veh=<%=Vehi%>&Vehreg=<%=Vreg%>&Date1=<%=datex2%>&Date2=<%=datex2%>&__showtitle=false"> 
