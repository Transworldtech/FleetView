...
<div id="reportData">
<iframe id="myIframe" width="100%" height="850px" src="http://myfleetview.com:8080/birt/frameset?__report=RA_Rating.rptdesign&sdate=<%=sdate%>&edate=<%=edate%>&vid=<%=vid%>&tripid=<%=tripid%>&__showtitle=false"> 
...
<a href="#" onclick="javascript:window.open('printrapidacc1.jsp?data1=<%=sdate%>&data2=<%=edate%>&vcode=<%=vid%>&tripid=<%=tripid%>');" title="Print Report"><img src="images/print.jpg" width="15px" height="15px"></a>&nbsp; &nbsp; <a href="excelrapidacc1.jsp?data1=<%=sdate%>&data2=<%=edate%>&vcode=<%=vid%>&tripid=<%=tripid%>" title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a>&nbsp;&nbsp;&nbsp;
<%=fleetview.PrintDate() %>
</div>
	 </td></tr>
</table>
