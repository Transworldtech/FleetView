...
<td class="hed">Speed in KMPH</td>
<td class="hed">Duration in Seconds</td>
...
<%
	...
	String sql="select * from "+tbname+" where VehCode='"+vid+"' and concat(FromDate,' ',FromTime)>='"+sdate+"' and concat(ToDate,' ',ToTime)<='"+edate+"'";
